---
title: Convert CFF to WOFF2 | .NET 
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert CFF to WOFF2 via C#" h2="Convert CFF to WOFF2, TTF & WOFF effortlessly on Windows and Linux. Create your own font converter by means of this Font API solution for .NET.">}}
...
3. Convert CFF to WOFF2 using [SaveToFormat](https://reference.aspose.com/font/net/aspose.font/font/methods/savetoformat) method and pass WOFF2 as [FontSavingFormats](https://reference.aspose.com/font/net/aspose.font/fontsavingformats)
...
{{< app/font/converter ".NET C# Code for CFF to WOFF2 Conversion" CFF WOFF2 TTF WOFF>}}
