...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert WOFF to WOFF2 via C#" h2="Convert WOFF to WOFF2, TTF &  vice versa on Windows and Linux. Create your own font converter by means of this Font API solution for .NET.">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="WOFF to WOFF2 Conversion on .NET" %}}
1. Open WOFF font using [Open](https://reference.aspose.com/font/net/aspose.font/font/methods/open/index) method
2. Specify the WOFF2 output settings 
3. Convert WOFF to WOFF2 using [SaveToFormat](https://reference.aspose.com/font/net/aspose.font/font/methods/savetoformat) method and pass WOFF2 as [FontSavingFormats](https://reference.aspose.com/font/net/aspose.font/fontsavingformats)
...
{{< app/font/converter ".NET C# Code for WOFF to WOFF2 Conversion" WOFF WOFF2 TTF>}}
