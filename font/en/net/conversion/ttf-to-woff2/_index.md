...
keywords: ttf to woff2 api, ttf2woff2 solution, ttf to woff2 net
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert TTF to WOFF2 via C#" h2="Convert TTF to WOFF2, WOFF &  vice versa on Windows and Linux. Create your own font converter by means of this Font API solution for .NET.">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="TTF to WOFF2 Conversion on .NET" %}}
1. Open TTF font using [Open](https://reference.aspose.com/font/net/aspose.font/font/methods/open/index) method
2. Specify the WOFF2 output settings 
3. Convert TTF to WOFF2 using [SaveToFormat](https://reference.aspose.com/font/net/aspose.font/font/methods/savetoformat) method and pass WOFF2 as [FontSavingFormats](https://reference.aspose.com/font/net/aspose.font/fontsavingformats)
...
{{< app/font/converter ".NET C# Code for TTF to WOFF2 Conversion" TTF WOFF2 WOFF>}}
