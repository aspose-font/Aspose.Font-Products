...
description: Convert TTF to WOFF2 using .NET API on Windows. Integrate this native TTF to WOFF2 font conversion functionality into your own solution.
...
h2: TTF to WOFF2 Conversion functionality for C№ .NET. API to transform fonts.
---
...
{{<section feature1>}}
---
title: TTF to WOFF2 Conversion on C#
...
item4: Convert TTF to WOFF2 using [*SaveToFormat()*](https://reference.aspose.com/font/net/aspose.font/font/methods/savetoformat) Method and pass WOFF2 as [FontSavingFormats](https://reference.aspose.com/font/net/aspose.font/fontsavingformats).
---
