...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert WOFF2 to TTF via C#" h2="Convert WOFF2 to TTF, WOFF &  vice versa on Windows and Linux. Create your own font converter by means of this Font API solution for .NET.">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="WOFF2 to TTF Conversion on .NET" %}}
1. Open WOFF2 font using [Open](https://reference.aspose.com/font/net/aspose.font/font/methods/open/index) method
2. Specify the TTF output settings 
3. Convert WOFF2 to TTF using [SaveToFormat](https://reference.aspose.com/font/net/aspose.font/font/methods/savetoformat) method and pass TTF as [FontSavingFormats](https://reference.aspose.com/font/net/aspose.font/fontsavingformats)
...
{{< app/font/converter ".NET C# Code for WOFF2 to TTF Conversion" WOFF2 TTF WOFF>}}
