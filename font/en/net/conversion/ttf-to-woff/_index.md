...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert TTF to WOFF via C#" h2="Convert TTF to WOFF, WOFF2 &  vice versa on Windows and Linux. Create your own font converter by means of this Font API solution for .NET.">}}
...
3. Convert TTF to WOFF using [SaveToFormat](https://reference.aspose.com/font/net/aspose.font/font/methods/savetoformat) method and pass WOFF as [FontSavingFormats](https://reference.aspose.com/font/net/aspose.font/fontsavingformats)
