...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert CFF to WOFF via C#" h2="Convert CFF to WOFF, TTF & WOFF2 effortlessly on Windows and Linux. Create your own font converter by means of this Font API solution for .NET.">}}
...
3. Convert CFF to WOFF using [SaveToFormat](https://reference.aspose.com/font/net/aspose.font/font/methods/savetoformat) method and pass WOFF as [FontSavingFormats](https://reference.aspose.com/font/net/aspose.font/fontsavingformats)
