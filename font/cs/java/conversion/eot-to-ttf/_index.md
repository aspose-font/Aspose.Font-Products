...
title: EOT to TTF Converter API | Jáva
description: Převeďte EOT na TTF pomocí Java API na Windows a Linux. Integrujte tuto nativní funkci převodu písem EOT na TTF do svého vlastního řešení.
keywords: eot to ttf java api, eot2ttf java řešení, eot to ttf java
...
{{<section feature1>}}
---
title: Převod EOT na TTF na Javě
...
item4: Převeďte EOT na TTF pomocí [*SaveToFormat()*](https://reference.aspose.com/font/java/com.aspose.font/Font#saveToFormat-java.io.OutputStream-com.aspose.font.FontSavingFormats-) Metoda a předání TTF jako [FontSavingFormats](https://reference.aspose.com/font/java/com.aspose.font/FontSavingFormats).
---

{{<section feature2>}}
---
title: Požadavky na konverzi
item1: "Aby bylo možné pokračovat v převodu EOT na TTF, je hlavním požadavkem Java Font API."
...
{{<section codeexample>}}
---
title: Java kód pro konverzi EOT na TTF
---