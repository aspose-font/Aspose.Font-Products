...
title: WOFF2 to WOFF Converter API | Jáva
description: Převeďte WOFF2 na WOFF pomocí Java API na Windows a Linux. Integrujte tuto nativní funkci převodu písem WOFF2 na WOFF do svého vlastního řešení.
keywords: woff2 to woff java api, woff22woff java řešení, woff2 to woff java
...
{{<section feature1>}}
---
title: Konverze WOFF2 na WOFF na Javě
...
item2: Otevřete písmo WOFF2 pomocí metody [*Open()*](https://reference.aspose.com/font/java/com.aspose.font/Font#open-com.aspose.font.FontDefinition-).
item3: Zadejte nastavení výstupu WOFF.
item4: Převeďte WOFF2 na WOFF pomocí [*SaveToFormat()*](https://reference.aspose.com/font/java/com.aspose.font/Font#saveToFormat-java.io.OutputStream-com.aspose.font.FontSavingFormats-) Metoda a předání WOFF jako [FontSavingFormats](https://reference.aspose.com/font/java/com.aspose.font/FontSavingFormats).
---

{{<section feature2>}}
---
title: Požadavky na konverzi
item1: "Pro převod WOFF2 na WOFF je hlavním požadavkem Java Font API."
...
item4: Podívejte se na příklad realizace zmíněné funkcionality v crossplatformním Aspose [WOFF2 to WOFF Converter](https://products.aspose.app/font/conversion/woff2-to-woff). Přejděte do našeho úložiště [GitHub](https://github.com/aspose-font/Aspose.Font-Documentation/tree/master/java-examples), kde najdete další příklady kódu, jak pracovat s Font API Solution for Java.
---

{{<section codeexample>}}
---
title: Java kód pro konverzi WOFF2 na WOFF
---