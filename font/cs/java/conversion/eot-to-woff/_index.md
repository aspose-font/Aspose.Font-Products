...
title: EOT to WOFF Converter API | Jáva
description: Převeďte EOT na WOFF pomocí Java API na Windows a Linux. Integrujte tuto nativní funkci převodu písem EOT na WOFF do svého vlastního řešení.
keywords: eot to woff java api, eot2woff java řešení, eot to woff java
...
{{<section feature1>}}
---
title: Převod EOT na WOFF na Javě
...
item4: Převeďte EOT na WOFF pomocí [*SaveToFormat()*](https://reference.aspose.com/font/java/com.aspose.font/Font#saveToFormat-java.io.OutputStream-com.aspose.font.FontSavingFormats-) Metoda a předání WOFF jako [FontSavingFormats](https://reference.aspose.com/font/java/com.aspose.font/FontSavingFormats).
---

{{<section feature2>}}
---
title: Požadavky na konverzi
item1: "Aby bylo možné pokračovat v převodu EOT na WOFF, je hlavním požadavkem Java Font API."
...
{{<section codeexample>}}
---
title: Java kód pro konverzi EOT na WOFF
---
