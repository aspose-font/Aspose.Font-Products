...
title: Interfejs API konwertera EOT na TTF |.NET
description: Konwertuj EOT na TTF za pomocą .NET API w systemie Windows. Zintegruj tę natywną funkcję konwersji czcionek EOT na TTF we własnym rozwiązaniu.
keywords: eot do ttf api, rozwiązanie eot2ttf, eot do ttf net
...
item2: Otwórz czcionkę EOT za pomocą metody [*Open()*](https://reference.aspose.com/font/net/aspose.font/font/methods/open/index).
item3: Określ ustawienia wyjściowe TTF.
item4: Konwertuj EOT na TTF za pomocą metody [*SaveToFormat()*](https://reference.aspose.com/font/net/aspose.font/font/methods/savetoformat) i przekaż TTF jako [FontSavingFormats](https://reference.aspose.com/font/net/aspose.font/fontsavingformats).
---
