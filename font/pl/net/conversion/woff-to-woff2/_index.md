...
title: Interfejs API konwertera WOFF do WOFF2 |.NET
description: Konwertuj WOFF na WOFF2 za pomocą .NET API w systemie Windows. Zintegruj tę natywną funkcję konwersji czcionek WOFF na WOFF2 we własnym rozwiązaniu.
keywords: woff do woff2 api, rozwiązanie woff12woff2, woff do woff2 net
...
item2: Otwórz czcionkę WOFF za pomocą metody [*Open()*](https://reference.aspose.com/font/net/aspose.font/font/methods/open/index).
item3: Określ ustawienia wyjściowe WOFF.
item4: Konwertuj WOFF na WOFF2 za pomocą metody [*SaveToFormat()*](https://reference.aspose.com/font/net/aspose.font/font/methods/savetoformat) i przekaż WOFF jako [FontSavingFormats](https://reference.aspose.com/font/net/aspose.font/fontsavingformats).
---
