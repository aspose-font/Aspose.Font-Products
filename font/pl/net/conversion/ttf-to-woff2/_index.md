...
title: Interfejs API konwertera TTF do WOFF2 |.NET
description: Konwertuj TTF na WOFF2 za pomocą .NET API w systemie Windows. Zintegruj tę natywną funkcję konwersji czcionek TTF na WOFF2 we własnym rozwiązaniu.
keywords: ttf do woff2 api, ttf2woff2 rozwiązanie, ttf do woff2 net
...
{{<section feature1>}}
---
title: Konwersja TTF do WOFF2 w C#
...
item2: Otwórz czcionkę TTF za pomocą metody [*Open()*](https://reference.aspose.com/font/net/aspose.font/font/methods/open/index).
item3: Określ ustawienia wyjściowe WOFF2.
item4: Konwertuj TTF na WOFF2 za pomocą metody [*SaveToFormat()*](https://reference.aspose.com/font/net/aspose.font/font/methods/savetoformat) i przekaż WOFF2 jako [FontSavingFormats](https://reference.aspose.com/font/net/aspose.font/fontsavingformats).
---
