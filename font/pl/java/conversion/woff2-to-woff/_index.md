...
title: Interfejs API konwertera WOFF2 do WOFF | Jawa
description: Konwertuj WOFF2 na WOFF za pomocą Java API w systemach Windows i Linux. Zintegruj tę natywną funkcję konwersji czcionek WOFF2 na WOFF we własnym rozwiązaniu.
keywords: woff2 do woff java api, woff22woff java rozwiązanie, woff2 do woff java
...
h2: Funkcjonalność konwersji WOFF2 do WOFF dla Javy. API do przekształcania czcionek.
---
...
{{<section feature1>}}
---
title: Konwersja WOFF2 do WOFF w Javie
...
item4: Konwertuj WOFF2 na WOFF za pomocą [*SaveToFormat()*](https://reference.aspose.com/font/java/com.aspose.font/Font#saveToFormat-java.io.OutputStream-com.aspose.font.FontSavingFormats-)   Metoda i przekazanie WOFF jako [FontSavingFormats](https://reference.aspose.com/font/java/com.aspose.font/FontSavingFormats).
---

{{<section feature2>}}
---
title: Wymagania dotyczące konwersji
item1: "Aby przejść do konwersji WOFF2 na WOFF, głównym wymaganiem jest Java Font API."
...
{{<section codeexample>}}
---
title: Kod Java do konwersji WOFF2 na WOFF
---