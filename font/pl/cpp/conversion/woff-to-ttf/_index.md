...
title: Interfejs API konwertera WOFF na TTF | C++
description: Konwertuj czcionki WOFF na czcionki TTF za pomocą tego interfejsu API C++. Funkcja konwersji działa w systemach Windows i Linux oraz w dowolnym środowisku programistycznym obsługującym C++.
metakeywords: c++ WOFF do TTF, WOFF do TTF rozwiązania c++, WOFF do TTF konwerter czcionek cpp
...
item4: Konwertuj WOFF na TTF za pomocą metody [*SaveToFormat()*](https://reference.aspose.com/font/cpp/class/aspose.font.font#a670ea97404fd72c2e51b0e8c543c8a45) i przekaż TTF jako [FontSavingFormats](https://reference.aspose.com/font/cpp/namespace/aspose.font#a93d0dcc7c00f5c7027d60e14a5433c74).
---
