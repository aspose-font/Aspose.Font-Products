...
title: Interfejs API konwertera EOT do WOFF2 | C++
description: Konwertuj czcionki EOT na WOFF2 za pomocą tego interfejsu API C++. Funkcja konwersji działa w systemach Windows i Linux oraz w dowolnym środowisku programistycznym obsługującym C++.
metakeywords: c++ EOT do WOFF2, EOT do WOFF2 rozwiązania c++, EOT do WOFF2 konwerter czcionek cpp
...
item4: Konwertuj EOT na WOFF2 za pomocą metody [*SaveToFormat()*](https://reference.aspose.com/font/cpp/class/aspose.font.font#a670ea97404fd72c2e51b0e8c543c8a45) i przekaż WOFF2 jako [FontSavingFormats](https://reference.aspose.com/font/cpp/namespace/aspose.font#a93d0dcc7c00f5c7027d60e14a5433c74).
---
...
{{<section codeexample>}}
---
title: Przykładowy kod C++ Konwersja EOT do WOFF2
---