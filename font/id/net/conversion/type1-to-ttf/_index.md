...
title: TYPE1 ke TTF Converter API |.NET
description: Konversi TYPE1 ke TTF menggunakan .NET API di Windows. Integrasikan fungsi konversi font TYPE1 ke TTF asli ini ke dalam solusi Anda sendiri.
keywords: type1 ke ttf api, solusi tpe12ttf, type1 ke ttf net
...
h2: Fungsi konversi TYPE1 ke TTF untuk C№ .NET. API untuk mengubah font.
---

{{<section overview>}}
---
p1: 'Konversi TYPE1 ke TTF dalam aplikasi berbasis .NET hanya dengan beberapa baris kode. Solusi Font API untuk # sangat mudah diintegrasikan ke dalam produk Anda. .NET API ini menyediakan struktur data font bersama dengan mesin terbang apa pun serta informasi penyandian untuk semua jenis font yang mewakili pemetaan antara kode karakter dan pengidentifikasi mesin terbang. API dapat merender mesin terbang atau teks yang diinginkan, serta mesin terbang khusus, yang dapat dirender dengan mengimplementasikan antarmuka menggunakan fungsionalitas grafis sederhana seperti titik bergerak, menggambar garis, dan kurva, dll.'
...
{{<section feature1>}}
---
title: Konversi TYPE1 ke TTF pada C#
...
item2: Buka font TYPE1 menggunakan Metode [*Open()*](https://reference.aspose.com/font/net/aspose.font/font/methods/open/index).
item3: Tentukan pengaturan keluaran TTF.
item4: Konversi TYPE1 ke TTF menggunakan Metode [*SaveToFormat()*](https://reference.aspose.com/font/net/aspose.font/font/methods/savetoformat) dan teruskan TTF sebagai [FontSavingFormats](https://reference.aspose.com/font/net/aspose.font/fontsavingformats).
---
...
{{<section codeexample>}}
---
title: Contoh kode C# TYPE1 ke konversi TTF
---