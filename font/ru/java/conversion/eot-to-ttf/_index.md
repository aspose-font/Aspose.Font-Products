...
title: API конвертера EOT в TTF | Ява
description: Преобразование EOT в TTF с помощью Java API в Windows и Linux. Интегрируйте эту встроенную функцию преобразования шрифтов EOT в TTF в свое собственное решение.
keywords: eot в ttf java API, eot2ttf java решение, eot в ttf java
...
{{<section feature1>}}
---
title: Преобразование EOT в TTF на Java
...
item4: Преобразование EOT в TTF с помощью [*SaveToFormat()*](https://reference.aspose.com/font/java/com.aspose.font/Font#saveToFormat-java.io.OutputStream-com.aspose.font.FontSavingFormats-)   Метод и передать TTF как [FontSavingFormats](https://reference.aspose.com/font/java/com.aspose.font/FontSavingFormats).
---

{{<section feature2>}}
---
title: Требования к конвертации
item1: "Чтобы продолжить преобразование EOT в TTF, основным требованием является Java Font API."
...
{{<section codeexample>}}
---
title: Код Java для преобразования EOT в TTF
---