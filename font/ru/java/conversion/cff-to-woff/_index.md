...
title: API конвертера CFF в WOFF | Ява
description: Преобразование CFF в WOFF с помощью Java API в Windows и Linux. Интегрируйте эту встроенную функцию преобразования шрифтов CFF в WOFF в свое собственное решение.
keywords: cff to woff java api, решение cff2woff java, cff to woff java
...
{{<section feature1>}}
---
title: Преобразование CFF в WOFF на Java
...
item4: Преобразование CFF в WOFF с помощью [*SaveToFormat()*](https://reference.aspose.com/font/java/com.aspose.font/Font#saveToFormat-java.io.OutputStream-com.aspose.font.FontSavingFormats-)   Метод и передать WOFF как [FontSavingFormats](https://reference.aspose.com/font/java/com.aspose.font/FontSavingFormats).
---

{{<section feature2>}}
---
title: Требования к конвертации
item1: "Чтобы продолжить преобразование CFF в WOFF, основным требованием является Java Font API."
