...
title: API конвертера TYPE1 в TTF | Ява
description: Преобразование TYPE1 в TTF с помощью Java API в Windows и Linux. Интегрируйте эту встроенную функцию преобразования шрифтов TYPE1 в TTF в свое собственное решение.
keywords: type1 в ttf java API, type12ttf java решение, type1 в ttf java
...
{{<section feature1>}}
---
title: Преобразование TYPE1 в TTF на Java
...
item4: Преобразование TYPE1 в TTF с помощью [*SaveToFormat()*](https://reference.aspose.com/font/java/com.aspose.font/Font#saveToFormat-java.io.OutputStream-com.aspose.font.FontSavingFormats-)   Метод и передать TTF как [FontSavingFormats](https://reference.aspose.com/font/java/com.aspose.font/FontSavingFormats).
---

{{<section feature2>}}
---
title: Требования к конвертации
item1: "Чтобы продолжить преобразование TYPE1 в TTF, основным требованием является Java Font API."
...
{{<section codeexample>}}
---
title: Код Java для преобразования TYPE1 в TTF
---