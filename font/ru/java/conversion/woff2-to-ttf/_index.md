...
title: API конвертера WOFF2 в TTF | Ява
description: Конвертируйте WOFF2 в TTF с помощью Java API в Windows и Linux. Интегрируйте эту встроенную функцию преобразования шрифтов WOFF2 в TTF в свое собственное решение.
keywords: woff2 в ttf java API, решение woff22ttf java, woff2 в ttf java
...
{{<section feature1>}}
---
title: Преобразование WOFF2 в TTF на Java
...
item4: Преобразование WOFF2 в TTF с помощью [*SaveToFormat()*](https://reference.aspose.com/font/java/com.aspose.font/Font#saveToFormat-java.io.OutputStream-com.aspose.font.FontSavingFormats-)   Метод и передать TTF как [FontSavingFormats](https://reference.aspose.com/font/java/com.aspose.font/FontSavingFormats).
---

{{<section feature2>}}
---
title: Требования к конвертации
item1: "Чтобы продолжить преобразование WOFF2 в TTF, основным требованием является Java Font API."
...
{{<section codeexample>}}
---
title: Код Java для преобразования WOFF2 в TTF
---