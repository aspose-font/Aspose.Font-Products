...
title: API конвертера TTF в WOFF | Ява
description: Преобразование TTF в WOFF с помощью Java API в Windows и Linux. Интегрируйте эту встроенную функцию преобразования шрифтов TTF в WOFF в свое собственное решение.
keywords: ttf to woff java api, решение ttf2woff java, ttf to woff java
...
{{<section feature1>}}
---
title: Преобразование TTF в WOFF на Java
...
item4: Преобразование TTF в WOFF с помощью [*SaveToFormat()*](https://reference.aspose.com/font/java/com.aspose.font/Font#saveToFormat-java.io.OutputStream-com.aspose.font.FontSavingFormats-)   Метод и передать WOFF как [FontSavingFormats](https://reference.aspose.com/font/java/com.aspose.font/FontSavingFormats).
---

{{<section feature2>}}
---
title: Требования к конвертации
item1: "Чтобы продолжить преобразование TTF в WOFF, основным требованием является Java Font API."
...
{{<section codeexample>}}
---
title: Код Java для преобразования TTF в WOFF
---
