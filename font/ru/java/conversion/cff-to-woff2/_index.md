...
title: API конвертера CFF в WOFF2 | Ява
...
keywords: cff to woff2 java api, решение cff2woff2 java, cff to woff2 java
...
{{<section feature1>}}
---
title: Преобразование CFF в WOFF2 на Java
...
item4: Преобразование CFF в WOFF2 с помощью [*SaveToFormat()*](https://reference.aspose.com/font/java/com.aspose.font/Font#saveToFormat-java.io.OutputStream-com.aspose.font.FontSavingFormats-)   Метод и передать WOFF2 как [FontSavingFormats](https://reference.aspose.com/font/java/com.aspose.font/FontSavingFormats).
---

{{<section feature2>}}
---
title: Требования к конвертации
item1: "Чтобы продолжить преобразование CFF в WOFF2, основным требованием является Java Font API."
...
{{<section codeexample>}}
---
title: Код Java для преобразования CFF в WOFF2
---