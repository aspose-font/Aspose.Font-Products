...
title: API конвертера EOT в WOFF2 | Ява
description: Преобразование EOT в WOFF2 с помощью Java API в Windows и Linux. Интегрируйте эту встроенную функцию преобразования шрифтов EOT в WOFF2 в свое собственное решение.
keywords: eot в woff2 java API, eot2woff2 java решение, eot в woff2 java
...
{{<section feature1>}}
---
title: Преобразование EOT в WOFF2 на Java
...
item2: Откройте шрифт EOT, используя метод [*Open()*](https://reference.aspose.com/font/java/com.aspose.font/Font#open-com.aspose.font.FontDefinition-).
item3: Укажите параметры вывода WOFF2.
item4: Преобразование EOT в WOFF2 с помощью [*SaveToFormat()*](https://reference.aspose.com/font/java/com.aspose.font/Font#saveToFormat-java.io.OutputStream-com.aspose.font.FontSavingFormats-)   Метод и передать WOFF как [FontSavingFormats](https://reference.aspose.com/font/java/com.aspose.font/FontSavingFormats).
---

{{<section feature2>}}
---
title: Требования к конвертации
item1: "Чтобы перейти к преобразованию EOT в WOFF2, основным требованием является Java Font API."
...
{{<section codeexample>}}
---
title: Код Java для преобразования EOT в WOFF2
---
