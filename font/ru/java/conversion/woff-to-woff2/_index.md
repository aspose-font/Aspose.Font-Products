...
title: API конвертера WOFF в WOFF2 | Ява
description: Преобразование WOFF в WOFF2 с помощью Java API в Windows и Linux. Интегрируйте эту встроенную функцию преобразования шрифтов WOFF в WOFF2 в свое собственное решение.
keywords: woff to woff2 java API, woff2woff2 java решение, woff to woff2 java
...
{{<section feature1>}}
---
title: Преобразование WOFF в WOFF2 на Java
...
item4: Преобразование WOFF в WOFF2 с помощью [*SaveToFormat()*](https://reference.aspose.com/font/java/com.aspose.font/Font#saveToFormat-java.io.OutputStream-com.aspose.font.FontSavingFormats-)   Метод и передать WOFF2 как [FontSavingFormats](https://reference.aspose.com/font/java/com.aspose.font/FontSavingFormats).
---

{{<section feature2>}}
---
title: Требования к конвертации
item1: "Чтобы продолжить преобразование WOFF в WOFF2, основным требованием является Java Font API."
...
{{<section codeexample>}}
---
title: Код Java для преобразования WOFF в WOFF2
---
