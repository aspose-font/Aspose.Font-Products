...
title: API конвертера EOT в WOFF | Ява
description: Преобразование EOT в WOFF с помощью Java API в Windows и Linux. Интегрируйте эту встроенную функцию преобразования шрифтов EOT в WOFF в свое собственное решение.
keywords: eot to woff java api, решение eot2woff java, eot to woff java
...
{{<section feature1>}}
---
title: Преобразование EOT в WOFF на Java
...
item4: Преобразование EOT в WOFF с помощью [*SaveToFormat()*](https://reference.aspose.com/font/java/com.aspose.font/Font#saveToFormat-java.io.OutputStream-com.aspose.font.FontSavingFormats-)   Метод и передать WOFF как [FontSavingFormats](https://reference.aspose.com/font/java/com.aspose.font/FontSavingFormats).
---

{{<section feature2>}}
---
title: Требования к конвертации
item1: "Чтобы продолжить преобразование EOT в WOFF, основным требованием является Java Font API."
...
{{<section codeexample>}}
---
title: Код Java для преобразования EOT в WOFF
---
