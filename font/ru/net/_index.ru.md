...
{{< blocks/products/pf/i18n/upper-banner h1=".NET API для управления шрифтами" h2="Загружайте, конвертируйте и сохраняйте различные шрифты, включая TrueType, CFF, OpenType и Type1, в приложениях на базе .NET." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/font/headers/aspose_font-for-net.svg" pfName="Aspose.Font" subTitlepfName="for .NET" downloadUrl="https://downloads.aspose.com/font/net" tryOnlineUrl="https://products.aspose.app/font/family"  >}}
...
<div class="diagram1 d2 d1-net">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="API шрифтов .NET" src="https://www.aspose.cloud/templates/aspose/img/products/font/aspose_font-for-net.svg"/>
  <header>
   Aspose.Font
  </header>
  <footer>
    ...
    <div class="col-lg-12">
      ...
      <div class="col-md-4">
        <ul>
          ...
          <li><a href="/font/net/conversion/cff-to-woff2/"> CFF на WOFF2</a></li>
        </ul>
      </div>	
      <div class="col-md-4">
        <ul>
...
{{< blocks/products/pf/slr-element name="Ссылки на API" href="https://apireference.aspose.com/font/net" >}}
