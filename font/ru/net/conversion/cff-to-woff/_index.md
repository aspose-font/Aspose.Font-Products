...
title: API конвертера CFF в WOFF |.NET
description: Преобразование CFF в WOFF с помощью .NET API в Windows. Интегрируйте эту встроенную функцию преобразования шрифтов CFF в WOFF в свое собственное решение.
keywords: cff to woff api, решение cff2woff, cff to woff net
...
item2: Откройте шрифт CFF, используя метод [*Open()*](https://reference.aspose.com/font/net/aspose.font/font/open/).
item3: Укажите параметры вывода WOFF.
item4: Преобразуйте CFF в WOFF с помощью метода [*SaveToFormat()*](https://reference.aspose.com/font/net/aspose.font/font/savetoformat/) и передайте WOFF как [FontSavingFormats](https://reference.aspose.com/font/net/aspose.font/fontsavingformats/).
---
