...
description: Преобразование TTF в WOFF с помощью .NET API в Windows. Интегрируйте эту встроенную функцию преобразования шрифтов TTF в WOFF в свое собственное решение.
keywords: ttf to woff api, решение ttf2woff, ttf to woff net
...
item2: Откройте шрифт TTF, используя метод [*Open()*](https://reference.aspose.com/font/net/aspose.font/font/methods/open/index).
item3: Укажите параметры вывода WOFF.
item4: Преобразуйте TTF в WOFF, используя метод [*SaveToFormat()*](https://reference.aspose.com/font/net/aspose.font/font/methods/savetoformat) и передайте WOFF как [FontSavingFormats](https://reference.aspose.com/font/net/aspose.font/fontsavingformats).
---
