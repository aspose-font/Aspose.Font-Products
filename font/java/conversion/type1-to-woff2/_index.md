...
description: TYPE1 to WOFF2 Fonts conversion using Java Font API
...
{{% blocks/products/pf/agp/code-autogen title="Java Code for TYPE1 to WOFF2 Conversion" gistPath="" %}}

{{< gist "aspose-com-gists" "031668fe9fb9c19501775ed8d56ca5a0" "convert-type1-to-woff2.java" >}}
