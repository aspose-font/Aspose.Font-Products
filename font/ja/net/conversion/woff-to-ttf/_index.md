...
item4: '[*SaveToFormat()*](https://reference.aspose.com/font/net/aspose.font/font/methods/savetoformat) メソッドを使用して WOFF を TTF に変換し、TTF を [FontSavingFormats](https://reference.aspose.com/font/net/aspose.font/fontSavingformats)。'
---
