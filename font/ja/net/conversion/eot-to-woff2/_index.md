...
item4: '[*SaveToFormat()*](https://reference.aspose.com/font/net/aspose.font/font/methods/savetoformat) メソッドを使用して EOT を WOFF2 に変換し、WOFF2 を [FontSavingFormats](https://reference.aspose.com/font/net/aspose.font/fontSavingformats)。'
---
