...
title: API de conversión de TYPE1 a WOFF | Java
description: Convierta TYPE1 a WOFF usando la API de Java en Windows y Linux. Integre esta función nativa de conversión de fuentes TYPE1 a WOFF en su propia solución.
keywords: type1 a woff java api, type12woff solución java, type1 a woff java
...
{{<section feature1>}}
---
title: Conversión de TYPE1 a WOFF en Java
...
item4: Convierta TYPE1 a WOFF usando [*SaveToFormat()*](https://reference.aspose.com/font/java/com.aspose.font/Font#saveToFormat-java.io.OutputStream-com.aspose.font.FontSavingFormats-) Método y pase WOFF como [FontSavingFormats](https://reference.aspose.com/font/java/com.aspose.font/FontSavingFormats).
---

{{<section feature2>}}
---
title: Requisitos de conversión
item1: "Para proceder a la conversión de TYPE1 a WOFF, el requisito principal es Java Font API."
...
{{<section codeexample>}}
---
title: Código Java para la conversión de TYPE1 a WOFF
---
