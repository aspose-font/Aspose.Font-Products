...
title: API de conversión de TYPE1 a WOFF2 | Java
description: Convierta TYPE1 a WOFF2 usando la API de Java en Windows y Linux. Integre esta funcionalidad nativa de conversión de fuentes TYPE1 a WOFF2 en su propia solución.
keywords: type1 a woff2 java api, type12woff2 solución java, type1 a woff2 java
...
{{<section feature1>}}
---
title: Conversión de TYPE1 a WOFF2 en Java
...
item4: Convierta TYPE1 a WOFF2 usando [*SaveToFormat()*](https://reference.aspose.com/font/java/com.aspose.font/Font#saveToFormat-java.io.OutputStream-com.aspose.font.FontSavingFormats-) Método y pase WOFF2 como [FontSavingFormats](https://reference.aspose.com/font/java/com.aspose.font/FontSavingFormats).
---

{{<section feature2>}}
---
title: Requisitos de conversión
item1: "Para proceder a la conversión de TYPE1 a WOFF2, el requisito principal es Java Font API."
...
{{<section codeexample>}}
---
title: Código Java para la conversión de TYPE1 a WOFF2
---
