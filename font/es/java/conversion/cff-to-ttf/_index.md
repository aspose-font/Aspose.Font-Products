...
title: API de conversión de CFF a TTF | Java
description: Convierta CFF a TTF utilizando la API de Java en Windows y Linux. Integre esta funcionalidad nativa de conversión de fuentes CFF a TTF en su propia solución.
keywords: cff a ttf java api, solución cff2ttf java, cff a ttf java
...
{{<section feature1>}}
---
title: Conversión de CFF a TTF en Java
...
item4: Convierta CFF a TTF usando [*SaveToFormat()*](https://reference.aspose.com/font/java/com.aspose.font/Font#saveToFormat-java.io.OutputStream-com.aspose.font.FontSavingFormats-) Método y pase TTF como [FontSavingFormats](https://reference.aspose.com/font/java/com.aspose.font/FontSavingFormats).
---

{{<section feature2>}}
---
title: Requisitos de conversión
item1: "Para proceder a la conversión de CFF a TTF, el requisito principal es Java Font API."
...
item4: Vea el ejemplo de realización de la funcionalidad mencionada en Aspose  multiplataforma [CFF to TTF Converter](https://products.aspose.app/font/conversion/cff-to-ttf). Vaya a nuestro repositorio [GitHub](https://github.com/aspose-font/Aspose.Font-Documentation/tree/master/java-examples) para obtener más ejemplos de código sobre cómo trabajar con Font API Solution para Java.
---
