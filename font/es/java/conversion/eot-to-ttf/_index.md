...
title: API de conversión de EOT a TTF | Java
description: Convierta EOT a TTF utilizando la API de Java en Windows y Linux. Integre esta funcionalidad nativa de conversión de fuentes EOT a TTF en su propia solución.
keywords: eot a ttf java api, solución eot2ttf java, eot a ttf java
...
{{<section feature1>}}
---
title: Conversión de EOT a TTF en Java
...
item4: Convierta EOT a TTF usando [*SaveToFormat()*](https://reference.aspose.com/font/java/com.aspose.font/Font#saveToFormat-java.io.OutputStream-com.aspose.font.FontSavingFormats-) Método y pase TTF como [FontSavingFormats](https://reference.aspose.com/font/java/com.aspose.font/FontSavingFormats).
---
...
{{<section codeexample>}}
---
title: Código Java para la conversión de EOT a TTF
---