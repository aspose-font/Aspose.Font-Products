...
title: API de conversión de CFF a TTF | .NET
description: Convierta CFF a TTF usando la API .NET en Windows. Integre esta funcionalidad nativa de conversión de fuentes CFF a TTF en su propia solución.
keywords: cff a ttf api, solución cff2ttf, cff a ttf net
...
item4: Convierta CFF a TTF usando el método [*SaveToFormat()*](https://reference.aspose.com/font/net/aspose.font/font/methods/savetoformat) y pase TTF como [FontSavingFormats](https://reference.aspose.com/font/net/aspose.font/fontsavingformats).
---
