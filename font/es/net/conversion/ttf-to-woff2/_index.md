...
title: API de conversión de TTF a WOFF2 | .NET
description: Convierta TTF a WOFF2 usando la API .NET en Windows. Integre esta función nativa de conversión de fuentes TTF a WOFF2 en su propia solución.
keywords: ttf a woff2 api, solución ttf2woff2, ttf a woff2 net
...
item4: Convierta TTF a WOFF2 usando el método [*SaveToFormat()*](https://reference.aspose.com/font/net/aspose.font/font/methods/savetoformat) y pase WOFF2 como [FontSavingFormats](https://reference.aspose.com/font/net/aspose.font/fontsavingformats).
---
