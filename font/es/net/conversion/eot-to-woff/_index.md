...
title: API de conversión de EOT a WOFF | .NET
description: Convierta EOT a WOFF usando .NET API en Windows. Integre esta funcionalidad nativa de conversión de fuentes EOT a WOFF en su propia solución.
keywords: eot a woff api, solución eot2woff, eot a woff net
...
item4: Convierta EOT a WOFF usando el método [*SaveToFormat()*](https://reference.aspose.com/font/net/aspose.font/font/methods/savetoformat) y pase WOFF como [FontSavingFormats](https://reference.aspose.com/font/net/aspose.font/fontsavingformats).
---
