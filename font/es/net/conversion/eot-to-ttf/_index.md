...
title: API de conversión de EOT a TTF | .NET
description: Convierta EOT a TTF usando .NET API en Windows. Integre esta funcionalidad nativa de conversión de fuentes EOT a TTF en su propia solución.
keywords: eot a ttf api, solución eot2ttf, eot a ttf net
...
{{<section feature1>}}
---
title: Conversión de EOT a TTF en C#
...
item2: Abra la fuente EOT usando el método [*Open()*](https://reference.aspose.com/font/net/aspose.font/font/methods/open/index).
item3: Especifique la configuración de salida TTF.
item4: Convierta EOT a TTF usando el método [*SaveToFormat()*](https://reference.aspose.com/font/net/aspose.font/font/methods/savetoformat) y pase TTF como [FontSavingFormats](https://reference.aspose.com/font/net/aspose.font/fontsavingformats).
---
...
item3: Vea el ejemplo de realización de la funcionalidad mencionada en Aspose  multiplataforma [EOT to TTF Converter](https://products.aspose.app/font/conversion/eot-to-ttf). Vaya a nuestro repositorio [GitHub](https://github.com/aspose-font/Aspose.Font-Documentation/tree/master/net-examples) para obtener más ejemplos de código sobre cómo trabajar con Font API Solution para C#.NET.
---

{{<section codeexample>}}
---
title: Ejemplo de código C# Conversión de EOT a TTF
---