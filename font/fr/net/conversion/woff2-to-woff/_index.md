...
description: Convertissez WOFF2 en WOFF à l'aide de l'API .NET sous Windows. Intégrez cette fonctionnalité native de conversion de police WOFF2 vers WOFF dans votre propre solution.
keywords: woff2 à woff net api, solution woff22woff net, woff2 à woff net
...
item4: Convertissez TTF en WOFF à l'aide de la méthode [*SaveToFormat()*](https://reference.aspose.com/font/net/aspose.font/font/savetoformat/) et transmettez WOFF en tant que [FontSavingFormats](https://reference.aspose.com/font/net/aspose.font/fontsavingformats/).
---
