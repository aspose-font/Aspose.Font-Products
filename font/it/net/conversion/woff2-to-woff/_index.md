...
description: Converti WOFF2 in WOFF utilizzando .NET API su Windows. Integra questa funzionalità nativa di conversione dei caratteri da WOFF2 a WOFF nella tua soluzione.
keywords: da woff2 a woff net api, woff22woff net solution, da woff2 a woff net
...
item4: Converti TTF in WOFF usando il metodo [*SaveToFormat()*](https://reference.aspose.com/font/net/aspose.font/font/methods/savetoformat) e passa WOFF come [FontSavingFormats](https://reference.aspose.com/font/net/aspose.font/fontsavingformats).
---
...
item3: Vedi l'esempio di realizzazione della funzionalità menzionata in Aspose [Convertitore da TTF a WOFF] multipiattaforma (https://products.aspose.app/font/conversion/ttf-to-woff). Vai al nostro repository [GitHub](https://github.com/aspose-font/Aspose.Font-Documentation/tree/master/net-examples) per ottenere altri esempi di codice su come lavorare con Font API Solution for C# .NET.
---
