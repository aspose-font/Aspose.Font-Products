...
title: CFF σε WOFF2 Converter API | Ιάβα
description: Μετατρέψτε το CFF σε WOFF χρησιμοποιώντας Java API σε Windows και Linux. Ενσωματώστε αυτήν τη λειτουργία μετατροπής εγγενούς γραμματοσειράς CFF σε WOFF στη δική σας λύση.
keywords: cff σε woff2 java api, cff2woff2 λύση java, cff σε woff2 java
...
{{<section feature1>}}
---
title: Μετατροπή CFF σε WOFF2 σε Java
...
item2: Ανοίξτε τη γραμματοσειρά CFF χρησιμοποιώντας τη μέθοδο [*Open()*](https://reference.aspose.com/font/java/com.aspose.font/Font#open-com.aspose.font.FontDefinition-).
item3: Καθορίστε τις ρυθμίσεις εξόδου WOFF2.
item4: Μετατρέψτε το CFF σε WOFF2 χρησιμοποιώντας [*SaveToFormat()*](https://reference.aspose.com/font/java/com.aspose.font/Font#saveToFormat-java.io.OutputStream-com.aspose.font.FontSavingFormats-) Μέθοδος και μεταβίβαση του WOFF2 ως [FontSavingFormats](https://reference.aspose.com/font/java/com.aspose.font/FontSavingFormats).
---

{{<section feature2>}}
---
title: Απαιτήσεις μετατροπής
item1: "Για να προχωρήσετε στη μετατροπή CFF σε WOFF2, το Java Font API είναι η κύρια απαίτηση."
...
{{<section codeexample>}}
---
title: Κώδικας Java για μετατροπή CFF σε WOFF2
---