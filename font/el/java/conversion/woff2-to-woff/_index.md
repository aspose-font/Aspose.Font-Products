...
title: API μετατροπέα WOFF2 σε WOFF | Ιάβα
description: Μετατρέψτε το WOFF2 σε WOFF χρησιμοποιώντας Java API σε Windows και Linux. Ενσωματώστε αυτήν τη λειτουργία μετατροπής εγγενών γραμματοσειρών WOFF2 σε WOFF στη δική σας λύση.
keywords: woff2 σε woff java api, woff22woff λύση java, woff2 σε woff java
...
{{<section feature1>}}
---
title: Μετατροπή WOFF2 σε WOFF σε Java
...
item2: Ανοίξτε τη γραμματοσειρά WOFF2 χρησιμοποιώντας τη μέθοδο [*Open()*](https://reference.aspose.com/font/java/com.aspose.font/Font#open-com.aspose.font.FontDefinition-).
item3: Καθορίστε τις ρυθμίσεις εξόδου WOFF.
item4: Μετατρέψτε το WOFF2 σε WOFF χρησιμοποιώντας [*SaveToFormat()*](https://reference.aspose.com/font/java/com.aspose.font/Font#saveToFormat-java.io.OutputStream-com.aspose.font.FontSavingFormats-) Μέθοδος και μεταβίβαση του WOFF ως [FontSavingFormats](https://reference.aspose.com/font/java/com.aspose.font/FontSavingFormats).
---

{{<section feature2>}}
---
title: Απαιτήσεις μετατροπής
item1: "Για να προχωρήσετε στη μετατροπή WOFF2 σε WOFF, το Java Font API είναι η κύρια απαίτηση."
