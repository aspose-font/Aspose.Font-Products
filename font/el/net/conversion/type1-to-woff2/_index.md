...
title: API μετατροπέα TYPE1 σε WOFF2 |.NET
description: Μετατρέψτε το TYPE1 σε WOFF2 χρησιμοποιώντας .NET API στα Windows. Ενσωματώστε αυτήν τη λειτουργία μετατροπής εγγενούς γραμματοσειράς TYPE1 σε WOFF2 στη δική σας λύση.
keywords: type1 σε woff2 api, λύση tpe12woff2, type1 σε woff2 net
...
{{<section feature1>}}
---
title: Μετατροπή TYPE1 σε WOFF2 σε C#
...
item2: Ανοίξτε τη γραμματοσειρά TYPE1 χρησιμοποιώντας τη μέθοδο [*Open()*](https://reference.aspose.com/font/net/aspose.font/font/methods/open/index).
item3: Καθορίστε τις ρυθμίσεις εξόδου WOFF2.
item4: Μετατρέψτε το TYPE1 σε WOFF2 χρησιμοποιώντας τη μέθοδο [*SaveToFormat()*](https://reference.aspose.com/font/net/aspose.font/font/methods/savetoformat) και περάστε το WOFF2 ως [FontSavingFormats](https://reference.aspose.com/font/net/aspose.font/fontsavingformats).
---
