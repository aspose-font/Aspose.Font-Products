...
title: API μετατροπέα WOFF σε TTF |.NET
description: Μετατρέψτε το WOFF σε TTF χρησιμοποιώντας .NET API στα Windows. Ενσωματώστε αυτήν τη λειτουργία μετατροπής εγγενών γραμματοσειρών WOFF σε TTF στη δική σας λύση.
keywords: woff σε ttf api, woff2ttf λύση, woff σε ttf net
...
{{<section feature1>}}
---
title: Μετατροπή WOFF σε TTF σε C#
...
item2: Ανοίξτε τη γραμματοσειρά WOFF χρησιμοποιώντας τη μέθοδο [*Open()*](https://reference.aspose.com/font/net/aspose.font/font/methods/open/index).
item3: Καθορίστε τις ρυθμίσεις εξόδου TTF.
item4: Μετατρέψτε το WOFF σε TTF χρησιμοποιώντας τη μέθοδο [*SaveToFormat()*](https://reference.aspose.com/font/net/aspose.font/font/methods/savetoformat) και περάστε το TTF ως [FontSavingFormats](https://reference.aspose.com/font/net/aspose.font/fontsavingformats).
---
