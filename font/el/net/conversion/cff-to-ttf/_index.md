...
description: Μετατρέψτε το CFF σε TTF χρησιμοποιώντας .NET API στα Windows. Ενσωματώστε αυτήν τη λειτουργία μετατροπής εγγενών γραμματοσειρών CFF σε TTF στη δική σας λύση.
keywords: cff σε ttf api, λύση cff2ttf, cff σε ttf net
...
h2: Λειτουργία μετατροπής CFF σε TTF για C№ .NET. API για μετατροπή γραμματοσειρών.
---
...
{{<section codeexample>}}
---
title: Παράδειγμα κώδικα C# μετατροπής CFF σε TTF
---