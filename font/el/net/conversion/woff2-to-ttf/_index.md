...
title: WOFF2 σε TTF Converter API |.NET
description: Μετατρέψτε το WOFF2 σε TTF χρησιμοποιώντας .NET API στα Windows. Ενσωματώστε αυτήν τη λειτουργία μετατροπής εγγενών γραμματοσειρών WOFF2 σε TTF στη δική σας λύση.
keywords: woff2 σε ttf api, λύση woff22ttf, woff2 σε ttf net
...
h2: Λειτουργία μετατροπής WOFF2 σε TTF για C№ .NET. API για μετατροπή γραμματοσειρών.
---
...
item2: Ανοίξτε τη γραμματοσειρά WOFF2 χρησιμοποιώντας τη μέθοδο [*Open()*](https://reference.aspose.com/font/net/aspose.font/font/methods/open/index).
item3: Καθορίστε τις ρυθμίσεις εξόδου TTF.
item4: Μετατρέψτε το WOFF2 σε TTF χρησιμοποιώντας τη μέθοδο [*SaveToFormat()*](https://reference.aspose.com/font/net/aspose.font/font/methods/savetoformat) και περάστε το TTF ως [FontSavingFormats](https://reference.aspose.com/font/net/aspose.font/fontsavingformats).
---
...
{{<section codeexample>}}
---
title: Παράδειγμα κώδικα C# μετατροπής WOFF2 σε TTF
---