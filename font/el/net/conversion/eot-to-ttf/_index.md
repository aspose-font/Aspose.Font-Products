...
title: EOT σε TTF Converter API |.NET
description: Μετατροπή EOT σε TTF χρησιμοποιώντας .NET API στα Windows. Ενσωματώστε αυτήν τη λειτουργία μετατροπής εγγενών γραμματοσειρών EOT σε TTF στη δική σας λύση.
keywords: eot to ttf api, eot2ttf λύση, eot to ttf net
...
h2: Λειτουργία μετατροπής EOT σε TTF για C№ .NET. API για μετατροπή γραμματοσειρών.
---
...
item4: Μετατρέψτε το EOT σε TTF χρησιμοποιώντας τη μέθοδο [*SaveToFormat()*](https://reference.aspose.com/font/net/aspose.font/font/methods/savetoformat) και περάστε το TTF ως [FontSavingFormats](https://reference.aspose.com/font/net/aspose.font/fontsavingformats).
---
...
{{<section codeexample>}}
---
title: Παράδειγμα κώδικα C# μετατροπής EOT σε TTF
---