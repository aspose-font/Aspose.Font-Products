...
title: CFF σε WOFF2 Converter API |.NET
description: Μετατρέψτε το CFF σε WOFF2 χρησιμοποιώντας .NET API στα Windows. Ενσωματώστε αυτήν τη λειτουργία μετατροπής εγγενών γραμματοσειρών CFF σε WOFF2 στη δική σας λύση.
keywords: cff σε woff2 api, λύση cff2woff2, cff σε woff2 net
...
item4: Μετατρέψτε το CFF σε WOFF2 χρησιμοποιώντας τη μέθοδο [*SaveToFormat()*](https://reference.aspose.com/font/net/aspose.font/font/methods/savetoformat) και περάστε το WOFF2 ως [FontSavingFormats](https://reference.aspose.com/font/net/aspose.font/fontsavingformats).
---
