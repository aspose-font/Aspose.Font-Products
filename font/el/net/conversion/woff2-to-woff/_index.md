...
description: Μετατρέψτε το WOFF2 σε WOFF χρησιμοποιώντας το .NET API στα Windows. Ενσωματώστε αυτήν τη λειτουργία μετατροπής εγγενών γραμματοσειρών WOFF2 σε WOFF στη δική σας λύση.
keywords: woff2 to woff net api, woff22woff net λύση, woff2 to woff net
...
item4: Μετατρέψτε το TTF σε WOFF χρησιμοποιώντας τη μέθοδο [*SaveToFormat()*](https://reference.aspose.com/font/net/aspose.font/font/savetoformat/) και περάστε το WOFF ως [FontSavingFormats](https://reference.aspose.com/font/net/aspose.font/fontsavingformats/).
---
