...
title: TYPE1 σε WOFF Converter API |.NET
description: Μετατρέψτε το TYPE1 σε WOFF χρησιμοποιώντας .NET API στα Windows. Ενσωματώστε αυτήν τη λειτουργία μετατροπής εγγενούς γραμματοσειράς TYPE1 σε WOFF στη δική σας λύση.
keywords: type1 σε woff api, type12woff λύση, type1 σε woff net
...
{{<section feature1>}}
---
title: Μετατροπή TYPE1 σε WOFF σε C#
...
item4: Μετατρέψτε το TYPE1 σε WOFF χρησιμοποιώντας τη μέθοδο [*SaveToFormat()*](https://reference.aspose.com/font/net/aspose.font/font/savetoformat/) και περάστε το WOFF ως [FontSavingFormats](https://reference.aspose.com/font/net/aspose.font/fontsavingformats/).
---
...
{{<section codeexample>}}
---
title: Παράδειγμα κώδικα C# μετατροπής TYPE1 σε WOFF
---