...
title: API μετατροπέα WOFF σε WOFF2 |.NET
description: Μετατρέψτε το WOFF σε WOFF2 χρησιμοποιώντας .NET API στα Windows. Ενσωματώστε αυτήν τη λειτουργία μετατροπής εγγενών γραμματοσειρών WOFF σε WOFF2 στη δική σας λύση.
keywords: woff σε woff2 api, woff12woff2 λύση, woff σε woff2 net
...
h2: Λειτουργία μετατροπής WOFF σε WOFF2 για C№ .NET. API για μετατροπή γραμματοσειρών.
---
...
item4: Μετατρέψτε το WOFF σε WOFF2 χρησιμοποιώντας τη μέθοδο [*SaveToFormat()*](https://reference.aspose.com/font/net/aspose.font/font/methods/savetoformat) και περάστε το WOFF ως [FontSavingFormats](https://reference.aspose.com/font/net/aspose.font/fontsavingformats).
---
...
{{<section codeexample>}}
---
title: Παράδειγμα κώδικα C# μετατροπής WOFF σε WOFF2
---