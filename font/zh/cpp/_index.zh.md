...
<p>
 Aspose.Font for C++ 是一个灵活且易于使用的库，可以处理不同的字体格式，例如 TTF、EOT、WOFF、CFF 和 Type1。使用此 API，您将能够从文件和流中读取不同的字体，提供它们的数据结构信息以及任何字形，对所有字体类型的信息进行编码，并保存字体。最终用户可以通过其渲染子系统获得帮助，以渲染任何所需的字形或文本。
</p>
...
<div class="diagram1 d1-cplus">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="C++ 字体处理 API" src="https://www.aspose.cloud/templates/aspose/img/products/font/aspose_font-for-cpp.svg"/>
  <header>
   Aspose.Font
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="平台独立性" description="该库完全支持在 Windows 和 Linux 平台上开发的 C++ 应用程序，具有 [系统要求](https://docs.aspose.com/font/cpp/system-requirements/)." >}}
<div class="diagram1 d1-cplus">
 <div class="d1-row">
  <div class="d1-col d1-left">
   <header>
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="字体操作 API" src="https://www.aspose.cloud/templates/aspose/img/products/font/aspose_font-for-cpp.svg"/>
  <header>
   Aspose.Font
  </header>
  <footer>
...
<div class="diagram1 d2 d1-cplus">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="C++ 字体 API" src="https://www.aspose.cloud/templates/aspose/img/products/font/aspose_font-for-cpp.svg"/>
  <header>
   Aspose.Font
  </header>
  <footer>
 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-12">
    ...
    <p>
     Aspose.Font for C++ 可以轻松加载、提取和保存 TrueType 字体格式。这里只是 TrueType TTF 的几行代码。
    </p>
   <div class="codeblock" id="code">
    <h3>
     加载、提取和保存 TrueType 字体 - C++
    </h3>
...
<div class="col-lg-12">
    <h4>
      你也可以 <a href="/font/cpp/conversion/"/> 尝试在线运行</a> 代码转换 TTF, WOFF, WOFF2, EOT, CFF, or Type1 in到TTF, WOFF, WOFF2.<br/>
      或使用以下链接：
    </h4>
	<div class="col-md-4">
		<ul>
...
{{< blocks/products/pf/slr-tab tabTitle="为什么 Aspose.Font 用于 C++？" tabId="success-stories" >}}
