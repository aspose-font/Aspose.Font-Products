...
description: Windows'ta .NET API kullanarak CFF'yi WOFF2'ye dönüştürün. Bu yerel CFF'yi WOFF2 yazı tipi dönüştürme işlevini kendi çözümünüze entegre edin.
keywords: cff'den woff2 api'ye, cff2woff2 çözümüne, cff'den woff2 ağına
