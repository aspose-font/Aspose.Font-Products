...
title: TTF'den WOFF2'ye Dönüştürücü API |.NET
description: Windows'ta .NET API kullanarak TTF'yi WOFF2'ye dönüştürün. Bu yerel TTF'yi WOFF2 yazı tipi dönüştürme işlevini kendi çözümünüze entegre edin.
keywords: ttf'den woff2 api'ye, ttf2woff2 çözümüne, ttf'den woff2 ağına
...
h2: C№ .NET için TTF'den WOFF2'ye Dönüştürme işlevi. Yazı tiplerini dönüştürmek için API.
---
...
item2: '[*Open()*](https://reference.aspose.com/font/net/aspose.font/font/methods/open/index) Yöntemini kullanarak TTF yazı tipini açın.'
item3: WOFF2 çıkış ayarlarını belirtin.
item4: "[*SaveToFormat()*](https://reference.aspose.com/font/net/aspose.font/font/methods/savetoformat) Yöntemini kullanarak TTF'yi WOFF2'ye dönüştürün ve WOFF2'yi olarak iletin [FontSavingFormats](https://reference.aspose.com/font/net/aspose.font/fontsavingformats)."
---
