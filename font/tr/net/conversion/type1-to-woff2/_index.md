...
title: TYPE1 - WOFF2 Dönüştürücü API |.NET
description: Windows'ta .NET API kullanarak TYPE1'i WOFF2'ye dönüştürün. Bu yerel TYPE1'den WOFF2'ye yazı tipi dönüştürme işlevini kendi çözümünüze entegre edin.
keywords: type1 ila woff2 api, tpe12woff2 çözümü, type1 ila woff2 net
...
h2: C№ .NET için TYPE1'den WOFF2'ye Dönüştürme işlevi. Yazı tiplerini dönüştürmek için API.
---
...
item2: '[*Open()*](https://reference.aspose.com/font/net/aspose.font/font/open/) Yöntemini kullanarak TYPE1 yazı tipini açın.'
item3: WOFF2 çıkış ayarlarını belirtin.
item4: "[*SaveToFormat()*](https://reference.aspose.com/font/net/aspose.font/font/savetoformat/) Yöntemini kullanarak TYPE1'i WOFF2'ye dönüştürün ve WOFF2'yi olarak iletin [FontSavingFormats](https://reference.aspose.com/font/net/aspose.font/fontsavingformats/)."
---
