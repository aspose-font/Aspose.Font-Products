...
description: Windows'ta .NET API kullanarak TTF'yi WOFF'a dönüştürün. Bu yerel TTF'yi WOFF yazı tipi dönüştürme işlevini kendi çözümünüze entegre edin.
keywords: woff api'ye ttf, ttf2woff çözümü, woff net'e ttf
...
item4: "[*SaveToFormat()*](https://reference.aspose.com/font/net/aspose.font/font/methods/savetoformat) Yöntemini kullanarak TTF'yi WOFF'a dönüştürün ve WOFF'u olarak iletin [FontSavingFormats](https://reference.aspose.com/font/net/aspose.font/fontsavingformats)."
---
