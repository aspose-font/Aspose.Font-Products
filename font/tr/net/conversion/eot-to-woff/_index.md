...
title: EOT - WOFF Dönüştürücü API |.NET
description: Windows'ta .NET API kullanarak EOT'u WOFF'a dönüştürün. Bu yerel EOT - WOFF yazı tipi dönüştürme işlevini kendi çözümünüze entegre edin.
keywords: eot'tan woff api'ye, eot2woff çözümünden, eot'tan woff ağına
...
{{<section feature1>}}
---
title: C#'da EOT'tan WOFF'a Dönüştürme
...
item2: '[*Open()*](https://reference.aspose.com/font/net/aspose.font/font/methods/open/index) Yöntemini kullanarak EOT yazı tipini açın.'
item3: WOFF çıkış ayarlarını belirtin.
item4: "[*SaveToFormat()*](https://reference.aspose.com/font/net/aspose.font/font/methods/savetoformat) Yöntemini kullanarak EOT'yi WOFF'a dönüştürün ve WOFF'u olarak iletin [FontSavingFormats](https://reference.aspose.com/font/net/aspose.font/fontsavingformats)."
---
