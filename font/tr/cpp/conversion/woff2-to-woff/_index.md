...
title: WOFF2'den WOFF'a Dönüştürücü API'sı | C++
description: Bu C++ API'sini kullanarak WOFF2'yi TTF Yazı Tiplerine dönüştürün. Dönüştürme işlevi, Windows ve Linux'ta ve C++'ı destekleyen herhangi bir geliştirme ortamında çalışır.
metakeywords: c++ WOFF2'den WOFF'a, WOFF2'den WOFF'a çözümler c++, WOFF2'den WOFF'a yazı tipi conerter cpp
...
h2: C++ için WOFF2'den WOFF'a Dönüştürme işlevi. Yazı tiplerini dönüştürmek için API.
---
...
{{<section feature1>}}
---
title: C++ üzerinde WOFF2'den WOFF'a Dönüştürme
...
item2: '[*Open()*](https://reference.aspose.com/font/cpp/class/aspose.font.font#ac2387bf04ccb5bac51cf37984d4ebf33) Yöntemini kullanarak WOFF2 yazı tipini açın.'
item3: WOFF çıkış ayarlarını belirtin.
item4: "[*SaveToFormat()*](https://reference.aspose.com/font/cpp/class/aspose.font.font#a670ea97404fd72c2e51b0e8c543c8a45) Yöntemini kullanarak WOFF2'yi WOFF'a dönüştürün ve WOFF'u olarak iletin [FontSavingFormats](https://reference.aspose.com/font/cpp/namespace/aspose.font#a93d0dcc7c00f5c7027d60e14a5433c74)."
---
