...
title: EOT'tan WOFF'a Dönüştürücü API'sı | C++
description: Bu C++ API'sini kullanarak EOT'u WOFF Yazı Tiplerine dönüştürün. Dönüştürme işlevi, Windows ve Linux'ta ve C++'ı destekleyen herhangi bir geliştirme ortamında çalışır.
metakeywords: c++ EOT - WOFF, EOT - WOFF çözümleri c++, EOT - WOFF yazı tipi conerter cpp
...
h2: C++ için EOT'tan WOFF'a Dönüştürme işlevi. Yazı tiplerini dönüştürmek için API.
---
...
item4: "[*SaveToFormat()*](https://reference.aspose.com/font/cpp/class/aspose.font.font#a670ea97404fd72c2e51b0e8c543c8a45) Yöntemini kullanarak EOT'yi WOFF'a dönüştürün ve WOFF'u olarak iletin [FontSavingFormats](https://reference.aspose.com/font/cpp/namespace/aspose.font#a93d0dcc7c00f5c7027d60e14a5433c74)."
---
