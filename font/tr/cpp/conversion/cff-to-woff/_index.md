...
title: CFF'den WOFF'a Dönüştürücü API'sı | C++
description: Bu C++ API'sini kullanarak CFF'yi WOFF Yazı Tiplerine dönüştürün. Dönüştürme işlevi, Windows ve Linux'ta ve C++'ı destekleyen herhangi bir geliştirme ortamında çalışır.
metakeywords: c++ CFF'den WOFF'a, CFF'den WOFF'a çözümler c++, CFF'den WOFF'a yazı tipi conerter cpp
...
item4: "[*SaveToFormat()*](https://reference.aspose.com/font/cpp/class/aspose.font.font#a670ea97404fd72c2e51b0e8c543c8a45) Yöntemini kullanarak CFF'yi WOFF'a dönüştürün ve WOFF'u olarak iletin [FontSavingFormats](https://reference.aspose.com/font/cpp/namespace/aspose.font#a93d0dcc7c00f5c7027d60e14a5433c74)."
---
