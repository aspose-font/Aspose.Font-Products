...
description: Bu C++ API'sini kullanarak TYPE1'i TTF Yazı Tiplerine dönüştürün. Dönüştürme işlevi, Windows ve Linux'ta ve C++'ı destekleyen herhangi bir geliştirme ortamında çalışır.
metakeywords: c++ TYPE1'den TTF'ye, TYPE1'den TTF'ye çözümler c++, TYPE1'den TTF'ye yazı tipi conerter cpp
...
h2: C++ için TYPE1'den TTF'ye Dönüştürme işlevi. Yazı tiplerini dönüştürmek için API.
---
...
item4: "[*SaveToFormat()*](https://reference.aspose.com/font/cpp/class/aspose.font.font#a670ea97404fd72c2e51b0e8c543c8a45) Yöntemini kullanarak TYPE1'i TTF'ye dönüştürün ve TTF'yi olarak iletin [FontSavingFormats](https://reference.aspose.com/font/cpp/namespace/aspose.font#a93d0dcc7c00f5c7027d60e14a5433c74)."
---
