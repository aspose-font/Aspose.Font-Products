...
title: EOT'tan WOFF'a Dönüştürücü API'sı | Java
description: Windows ve Linux'ta Java API kullanarak EOT'u WOFF'a dönüştürün. Bu yerel EOT - WOFF yazı tipi dönüştürme işlevini kendi çözümünüze entegre edin.
keywords: eot to woff java api, eot2woff java çözümü, eot to woff java
...
{{<section feature1>}}
---
title: Java'da EOT'tan WOFF'a Dönüşüm
...
item4: "[*SaveToFormat()*](https://reference.aspose.com/font/java/com.aspose.font/Font#saveToFormat-java.io.OutputStream-com.aspose.font.FontSavingFormats-) kullanarak EOT'yi WOFF'a dönüştürün Yöntem ve WOFF'u [FontSavingFormats](https://reference.aspose.com/font/java/com.aspose.font/FontSavingFormats) olarak iletin."
---

{{<section feature2>}}
---
title: Dönüşüm Gereksinimleri
item1: "EOT'tan WOFF'a dönüştürmeye devam etmek için Java Yazı Tipi API'si ana gereksinimdir."
