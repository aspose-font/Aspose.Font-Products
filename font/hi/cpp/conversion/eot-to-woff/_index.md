...
title: EOT को WOFF में बदलें | सी++
description: इस C++ API का उपयोग करके EOT को WOFF फ़ॉन्ट्स में बदलें। रूपांतरण कार्यक्षमता विंडोज और लिनक्स पर और सी ++ का समर्थन करने वाले किसी भी विकास वातावरण में काम करती है।
...
h2: C++ के लिए EOT से WOFF रूपांतरण कार्यक्षमता। फ़ॉन्ट बदलने के लिए एपीआई।
---
...
{{<section feature1>}}
---
title: C++ पर EOT से WOFF रूपांतरण
...
item4: '[*SaveToFormat()*](https://reference.aspose.com/font/cpp/class/aspose.font.font#a670ea97404fd72c2e51b0e8c543c8a45) विधि का उपयोग करके EOT को WOFF में बदलें और WOFF को केरूपमेंपासकरें[FontSavingFormats](https://reference.aspose.com/font/cpp/namespace/aspose.font#a93d0dcc7c00f5c7027d60e14a5433c74)।'
---
...
{{<section codeexample>}}
---
title: C++ कोड उदाहरण EOT से WOFF रूपांतरण
---
