...
item2: '[*ओपन()*](https://reference.aspose.com/font/net/aspose.font/font/open/) विधि का उपयोग करके WOFF फ़ॉन्ट खोलें।'
item3: WOFF आउटपुट सेटिंग्स निर्दिष्ट करें।
item4: '[*SaveToFormat()*](https://reference.aspose.com/font/net/aspose.font/font/savetoformat/) विधि का उपयोग करके WOFF को WOFF2 में बदलें और WOFF को केरूपमेंपासकरें [FontSavingFormats](https://reference.aspose.com/font/net/aspose.font/fontsavingformats/)।'
---
