...
description: विंडोज़ पर .NET API का उपयोग करके WOFF2 को WOFF में बदलें। इस मूल WOFF2 को अपने स्वयं के समाधान में WOFF फ़ॉन्ट रूपांतरण कार्यक्षमता में एकीकृत करें।
