...
title: WOFF से TTF कन्वर्टर API |.NET
description: विंडोज़ पर .NET API का उपयोग करके WOFF को TTF में बदलें। इस मूल WOFF को अपने स्वयं के समाधान में TTF फ़ॉन्ट रूपांतरण कार्यक्षमता में एकीकृत करें।
...
{{<section feature1>}}
---
title: 'सी # पर टीटीएफ रूपांतरण के लिए डब्ल्यूओएफएफ'
...
item4: '[*SaveToFormat()*](https://reference.aspose.com/font/net/aspose.font/font/methods/savetoformat) विधि का उपयोग करके WOFF को TTF में बदलें और TTF को केरूपमेंपासकरें [FontSavingFormats](https://reference.aspose.com/font/net/aspose.font/fontsavingformats)।'
---
