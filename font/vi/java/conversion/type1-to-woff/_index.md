...
title: API chuyển đổi TYPE1 sang WOFF | Java
description: Chuyển đổi TYPE1 thành WOFF bằng cách sử dụng API Java trên Windows và Linux. Tích hợp chức năng chuyển đổi phông chữ TYPE1 sang WOFF gốc này vào giải pháp của riêng bạn.
keywords: type1 đến woff java api, type12woff java solution, type1 đến woff java
...
{{<section feature1>}}
---
title: Chuyển đổi TYPE1 sang WOFF trên Java
...
{{<section codeexample>}}
---
title: Mã Java cho Chuyển đổi TYPE1 sang WOFF
---
