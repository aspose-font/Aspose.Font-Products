...
title: API chuyển đổi WOFF2 sang WOFF | Java
description: Chuyển đổi WOFF2 sang WOFF bằng Java API trên Windows và Linux. Tích hợp chức năng chuyển đổi phông chữ WOFF2 sang WOFF gốc này vào giải pháp của riêng bạn.
keywords: woff2 đến woff java api, woff22woff java giải pháp, woff2 đến woff java
...
{{<section feature1>}}
---
title: Chuyển đổi WOFF2 sang WOFF trên Java
...
item4: Xem ví dụ về việc thực hiện chức năng được đề cập trong Aspose đa nền tảng [Bộ chuyển đổi WOFF2 sang WOFF](https://products.aspose.app/font/conversion/woff2-to-woff). Truy cập kho lưu trữ [GitHub](https://github.com/aspose-font/Aspose.Font-Documentation/tree/master/java-examples) của chúng tôi để nhận thêm các ví dụ mã về cách làm việc với Giải pháp API Phông chữ cho Java.
---

{{<section codeexample>}}
---
title: Mã Java cho chuyển đổi WOFF2 sang WOFF
---