...
title: API chuyển đổi TYPE1 sang WOFF2 | Java
description: Chuyển đổi TYPE1 thành WOFF2 bằng Java API trên Windows và Linux. Tích hợp chức năng chuyển đổi phông chữ TYPE1 sang WOFF2 gốc này vào giải pháp của riêng bạn.
keywords: type1 đến woff2 java api, type12woff2 java solution, type1 đến woff2 java
...
{{<section feature1>}}
---
title: Chuyển đổi TYPE1 sang WOFF2 trên Java
