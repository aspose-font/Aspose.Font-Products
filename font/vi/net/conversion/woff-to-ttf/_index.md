...
title: API chuyển đổi WOFF sang TTF | .NET
description: Chuyển đổi WOFF sang TTF bằng .NET API trên Windows. Tích hợp chức năng chuyển đổi phông chữ WOFF sang TTF gốc này vào giải pháp của riêng bạn.
keywords: woff tới ttf api, woff2ttf giải pháp, woff tới ttf net
...
item4: Chuyển đổi WOFF sang TTF bằng phương pháp [*SaveToFormat()*](https://reference.aspose.com/font/net/aspose.font/font/methods/savetoformat) và chuyển TTF dưới dạng [FontSavingFormats](https://thamchiếu.aspose.com/font/net/aspose.font/fontsavingformats).
---
