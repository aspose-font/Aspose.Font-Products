...
title: API chuyển đổi CFF sang WOFF2 | .NET
description: Chuyển đổi CFF thành WOFF2 bằng .NET API trên Windows. Tích hợp chức năng chuyển đổi phông chữ CFF sang WOFF2 gốc này vào giải pháp của riêng bạn.
keywords: cff đến woff2 api, giải pháp cff2woff2, cff đến woff2 net
...
item4: Chuyển đổi CFF thành WOFF2 bằng phương pháp [*SaveToFormat()*](https://reference.aspose.com/font/net/aspose.font/font/methods/savetoformat) và chuyển WOFF2 dưới dạng [FontSavingFormats](https://thamchiếu.aspose.com/font/net/aspose.font/fontsavingformats).
---
