...
title: API chuyển đổi TTF sang WOFF2 | .NET
description: Chuyển đổi TTF sang WOFF2 bằng .NET API trên Windows. Tích hợp chức năng chuyển đổi phông chữ TTF sang WOFF2 gốc này vào giải pháp của riêng bạn.
keywords: ttf tới woff2 api, ttf2woff2 giải pháp, ttf tới woff2 net
...
item4: Chuyển đổi TTF thành WOFF2 bằng phương thức [*SaveToFormat()*](https://reference.aspose.com/font/net/aspose.font/font/methods/savetoformat) và chuyển WOFF2 dưới dạng [FontSavingFormats](https://thamchiếu.aspose.com/font/net/aspose.font/fontsavingformats).
---
