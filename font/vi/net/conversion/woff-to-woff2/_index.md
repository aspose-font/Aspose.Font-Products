...
title: API chuyển đổi WOFF sang WOFF2 | .NET
description: Chuyển đổi WOFF thành WOFF2 bằng .NET API trên Windows. Tích hợp chức năng chuyển đổi phông chữ WOFF sang WOFF2 gốc này vào giải pháp của riêng bạn.
keywords: woff đến woff2 api, woff12woff2 giải pháp, woff đến woff2 net
...
item2: Mở phông chữ WOFF bằng phương pháp [*Open()*](https://reference.aspose.com/font/net/aspose.font/font/methods/open/index).
item3: Chỉ định cài đặt đầu ra WOFF.
item4: Chuyển đổi WOFF thành WOFF2 bằng phương thức [*SaveToFormat()*](https://reference.aspose.com/font/net/aspose.font/font/methods/savetoformat) và chuyển WOFF dưới dạng [FontSavingFormats](https://thamchiếu.aspose.com/font/net/aspose.font/fontsavingformats).
---
