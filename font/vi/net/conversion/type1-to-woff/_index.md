...
title: API chuyển đổi TYPE1 sang WOFF | .NET
description: Chuyển đổi TYPE1 thành WOFF bằng .NET API trên Windows. Tích hợp chức năng chuyển đổi phông chữ TYPE1 sang WOFF gốc này vào giải pháp của riêng bạn.
keywords: type1 đến woff api, type12woff solution, type1 đến woff net
...
item2: Mở phông chữ TYPE1 bằng phương pháp [*Open()*](https://reference.aspose.com/font/net/aspose.font/font/methods/open/index).
item3: Chỉ định cài đặt đầu ra WOFF.
item4: Chuyển đổi TYPE1 thành WOFF bằng phương pháp [*SaveToFormat()*](https://reference.aspose.com/font/net/aspose.font/font/methods/savetoformat) và chuyển WOFF dưới dạng [FontSavingFormats](https://thamchiếu.aspose.com/font/net/aspose.font/fontsavingformats).
---
