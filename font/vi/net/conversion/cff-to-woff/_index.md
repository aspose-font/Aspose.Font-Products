...
title: API chuyển đổi CFF sang WOFF | .NET
description: Chuyển đổi CFF thành WOFF bằng .NET API trên Windows. Tích hợp chức năng chuyển đổi phông chữ CFF sang WOFF gốc này vào giải pháp của riêng bạn.
...
item4: Chuyển đổi CFF thành WOFF bằng phương pháp [*SaveToFormat()*](https://reference.aspose.com/font/net/aspose.font/font/methods/savetoformat) và chuyển WOFF dưới dạng [FontSavingFormats](https://thamchiếu.aspose.com/font/net/aspose.font/fontsavingformats).
---
