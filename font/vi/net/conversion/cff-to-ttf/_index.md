...
title: API chuyển đổi CFF sang TTF | .NET
description: Chuyển đổi CFF sang TTF bằng .NET API trên Windows. Tích hợp chức năng chuyển đổi phông chữ CFF sang TTF gốc này vào giải pháp của riêng bạn.
keywords: cff sang ttf api, cff2ttf giải pháp, cff sang ttf net
...
item2: Mở phông chữ CFF bằng phương pháp [*Open()*](https://reference.aspose.com/font/net/aspose.font/font/methods/open/index).
item3: Chỉ định cài đặt đầu ra TTF.
item4: Chuyển đổi CFF thành TTF bằng phương pháp [*SaveToFormat()*](https://reference.aspose.com/font/net/aspose.font/font/methods/savetoformat) và chuyển TTF dưới dạng [FontSavingFormats](https://thamchiếu.aspose.com/font/net/aspose.font/fontsavingformats).
---
