...
title: API chuyển đổi EOT sang WOFF2 | C ++
description: Chuyển đổi Phông chữ EOT sang WOFF2 bằng cách sử dụng API C ++ này. Chức năng Chuyển đổi hoạt động trên Windows và Linux và trong bất kỳ môi trường phát triển nào hỗ trợ C ++.
metakeywords: c ++ EOT to WOFF2, EOT to WOFF2 giải pháp c ++, EOT to WOFF2 font conerter cpp
...
item4: Chuyển đổi EOT thành WOFF2 bằng phương thức [*SaveToFormat()*](https://reference.aspose.com/font/cpp/class/aspose.font.font#a670ea97404fd72c2e51b0e8c543c8a45) và chuyển WOFF2 dưới dạng [FontSavingFormats](https://thamchiếu.aspose.com/font/cpp/namespace/aspose.font#a93d0dcc7c00f5c7027d60e14a5433c74).
---
