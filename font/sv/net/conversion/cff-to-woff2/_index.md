...
title: CFF till WOFF2 Converter API |.NET
description: Konvertera CFF till WOFF2 med .NET API på Windows. Integrera denna inbyggda CFF till WOFF2 teckensnittskonverteringsfunktion i din egen lösning.
keywords: cff till woff2 api, cff2woff2 lösning, cff till woff2 net
...
item2: Öppna CFF-teckensnitt med metoden [*Open()*](https://reference.aspose.com/font/net/aspose.font/font/open/).
item3: Ange WOFF2-utgångsinställningarna.
item4: Konvertera CFF till WOFF2 med metoden [*SaveToFormat()*](https://reference.aspose.com/font/net/aspose.font/font/savetoformat/) och skicka WOFF2 som [FontSavingFormats](https://reference.aspose.com/font/net/aspose.font/fontsavingformats/).
---
