...
description: Konvertera TTF till WOFF med .NET API på Windows. Integrera denna inbyggda TTF till WOFF-teckensnittskonverteringsfunktion i din egen lösning.
keywords: ttf till woff api, ttf2woff lösning, ttf till woff nät
...
item2: Öppna TTF-teckensnitt med metoden [*Open()*](https://reference.aspose.com/font/net/aspose.font/font/methods/open/index).
item3: Ange WOFF-utgångsinställningar.
item4: Konvertera TTF till WOFF med metoden [*SaveToFormat()*](https://reference.aspose.com/font/net/aspose.font/font/methods/savetoformat) och skicka WOFF som [FontSavingFormats](https://reference.aspose.com/font/net/aspose.font/fontsavingformats).
---
