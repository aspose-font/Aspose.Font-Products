...
title: واجهة برمجة تطبيقات محول TYPE1 إلى WOFF2 | جافا
description: قم بتحويل TYPE1 إلى WOFF2 باستخدام Java API على نظامي التشغيل Windows و Linux. قم بدمج TYPE1 الأصلي مع وظيفة تحويل خط WOFF2 في الحل الخاص بك.
keywords: type1 إلى woff2 java api ، type12woff2 java solution ، type1 to woff2 java
...
h2: وظائف تحويل TYPE1 إلى WOFF2 لجافا. API لتحويل الخطوط.
---

{{<section overview>}}
---
p1: تحويل TYPE1 إلى WOFF2 داخل التطبيقات المستندة إلى Java مع بضعة أسطر من التعليمات البرمجية. من السهل حقًا دمج Font API Solution لـ С ++ في منتجك. توفر Java API هذه بنية بيانات الخط جنبًا إلى جنب مع أي حرف رسومي بالإضافة إلى معلومات الترميز لجميع أنواع الخطوط التي تمثل تعيينًا بين رموز الأحرف ومعرفات الحروف الرسومية. يمكن لواجهة برمجة التطبيقات (API) تقديم أي حرف رسومي أو نص مرغوب فيه ، بالإضافة إلى صور رمزية خاصة ، والتي يمكن تقديمها عن طريق تنفيذ واجهات باستخدام وظائف رسومات بسيطة مثل نقطة التحرك ، ورسم الخط ، والمنحنى ، إلخ.
...
{{<section feature1>}}
---
title: تحويل TYPE1 إلى WOFF2 على Java
...
item4: تحويل TYPE1 إلى WOFF2 باستخدام [*SaveToFormat()*](https://reference.aspose.com/font/java/com.aspose.font/Font#saveToFormat-java.io.OutputStream-com.aspose.font.FontSavingFormats-) الطريقة وتمرير WOFF2 كـ [FontSavingFormats](https://reference.aspose.com/font/java/com.aspose.font/FontSavingFormats).
---

{{<section feature2>}}
---
title: متطلبات التحويل
item1: "للشروع في تحويل TYPE1 إلى WOFF2 ، فإن Java Font API هي المطلب الرئيسي."
...
{{<section codeexample>}}
---
title: كود جافا من TYPE1 إلى WOFF2 التحويل
---
