...
title: واجهة برمجة تطبيقات محول WOFF إلى WOFF2 | جافا
description: تحويل WOFF إلى WOFF2 باستخدام Java API على نظامي التشغيل Windows و Linux. ادمج WOFF الأصلي مع وظيفة تحويل خط WOFF2 في الحل الخاص بك.
keywords: woff إلى woff2 java api ، woff2woff2 java solution ، woff to woff2 java
...
h2: WOFF إلى وظائف تحويل WOFF2 لجافا. API لتحويل الخطوط.
---

{{<section overview>}}
---
p1: تحويل WOFF إلى WOFF2 ضمن التطبيقات المستندة إلى Java مع بضعة أسطر من التعليمات البرمجية. من السهل حقًا دمج Font API Solution لـ С ++ في منتجك. توفر Java API هذه بنية بيانات الخط جنبًا إلى جنب مع أي حرف رسومي بالإضافة إلى معلومات الترميز لجميع أنواع الخطوط التي تمثل تعيينًا بين رموز الأحرف ومعرفات الحروف الرسومية. يمكن لواجهة برمجة التطبيقات (API) تقديم أي حرف رسومي أو نص مرغوب فيه ، بالإضافة إلى صور رمزية خاصة ، والتي يمكن تقديمها عن طريق تنفيذ واجهات باستخدام وظائف رسومات بسيطة مثل نقطة التحرك ، ورسم الخط ، والمنحنى ، إلخ.
...
{{<section feature1>}}
---
title: تحويل WOFF إلى WOFF2 على Java
...
item2: افتح خط WOFF باستخدام أسلوب  [*Open()*](https://reference.aspose.com/font/java/com.aspose.font/Font#open-com.aspose.font.FontDefinition-).
item3: حدد إعدادات إخراج WOFF2.
item4: تحويل WOFF إلى WOFF2 باستخدام [*SaveToFormat()*](https://reference.aspose.com/font/java/com.aspose.font/Font#saveToFormat-java.io.OutputStream-com.aspose.font.FontSavingFormats-) الطريقة وتمرير WOFF2 كـ [FontSavingFormats](https://reference.aspose.com/font/java/com.aspose.font/FontSavingFormats).
---

{{<section feature2>}}
---
title: متطلبات التحويل
item1: "للشروع في تحويل WOFF إلى WOFF2 ، فإن Java Font API هي المطلب الرئيسي."
...
{{<section codeexample>}}
---
title: كود جافا لـ WOFF إلى WOFF2 التحويل
---
