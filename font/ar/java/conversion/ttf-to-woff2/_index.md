...
title: واجهة برمجة تطبيقات محول TTF إلى WOFF2 | جافا
description: قم بتحويل TTF إلى WOFF2 باستخدام Java API على نظامي التشغيل Windows و Linux. قم بدمج TTF الأصلي مع وظيفة تحويل خط WOFF2 في الحل الخاص بك.
keywords: ttf إلى woff2 java api ، ttf2woff2 java solution ، ttf to woff2 java
...
h2: وظائف تحويل TTF إلى WOFF2 لجافا. API لتحويل الخطوط.
---

{{<section overview>}}
---
p1: تحويل TTF إلى WOFF2 ضمن التطبيقات المستندة إلى Java مع بضعة أسطر من التعليمات البرمجية. من السهل حقًا دمج Font API Solution لـ С ++ في منتجك. توفر Java API هذه بنية بيانات الخط جنبًا إلى جنب مع أي حرف رسومي بالإضافة إلى معلومات الترميز لجميع أنواع الخطوط التي تمثل تعيينًا بين رموز الأحرف ومعرفات الحروف الرسومية. يمكن لواجهة برمجة التطبيقات (API) تقديم أي حرف رسومي أو نص مرغوب فيه ، بالإضافة إلى صور رمزية خاصة ، والتي يمكن تقديمها عن طريق تنفيذ واجهات باستخدام وظائف رسومات بسيطة مثل نقطة التحرك ، ورسم الخط ، والمنحنى ، إلخ.
...
{{<section feature1>}}
---
title: تحويل TTF إلى WOFF2 على Java
...
item2: افتح خط TTF باستخدام أسلوب  [*Open()*](https://reference.aspose.com/font/java/com.aspose.font/Font#open-com.aspose.font.FontDefinition-).
item3: حدد إعدادات إخراج WOFF2.
item4: تحويل TTF إلى WOFF2 باستخدام [*SaveToFormat()*](https://reference.aspose.com/font/java/com.aspose.font/Font#saveToFormat-java.io.OutputStream-com.aspose.font.FontSavingFormats-) الطريقة وتمرير WOFF2 كـ [FontSavingFormats](https://reference.aspose.com/font/java/com.aspose.font/FontSavingFormats).
---

{{<section feature2>}}
---
title: متطلبات التحويل
item1: "للمتابعة لتحويل TTF إلى WOFF2 ، فإن Java Font API هي المطلب الرئيسي."
...
{{<section codeexample>}}
---
title: كود جافا لتحويل TTF إلى WOFF2
---
