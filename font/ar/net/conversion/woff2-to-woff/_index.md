...
description: تحويل WOFF2 إلى WOFF باستخدام .NET API على Windows. ادمج WOFF2 الأصلي مع وظيفة تحويل خط WOFF في الحل الخاص بك.
keywords: woff2 إلى woff net api ، حل صافي woff22woff ، woff2 إلى شبكة woff
...
item4: قم بتحويل TTF إلى WOFF باستخدام أسلوب [*SaveToFormat()*](https://reference.aspose.com/font/net/aspose.font/font/methods/savetoformat) ومرر WOFF كـ [FontSavingFormats](https://reference.aspose.com/font/net/aspose.font/fontsavingformats).
---
