...
title: واجهة برمجة تطبيقات محول EOT إلى WOFF2 | .NET
description: تحويل EOT إلى WOFF2 باستخدام .NET API على Windows. ادمج وظيفة تحويل الخط EOT الأصلية مع WOFF2 في الحل الخاص بك.
keywords: eot إلى woff2 api ، محلول eot2woff2 ، eot إلى شبكة woff2
...
h2: وظيفة تحويل EOT إلى WOFF2 لـ C№ .NET. API لتحويل الخطوط.
---

{{<section overview>}}
---
p1: 'تحويل EOT إلى WOFF2 ضمن التطبيقات المستندة إلى .NET مع بضعة أسطر من التعليمات البرمجية. من السهل حقًا دمج Font API Solution لـ С # في منتجك. يوفر .NET API بنية بيانات الخط جنبًا إلى جنب مع أي حرف رسومي بالإضافة إلى معلومات الترميز لجميع أنواع الخطوط التي تمثل تعيينًا بين رموز الأحرف ومعرفات الحروف الرسومية. يمكن لواجهة برمجة التطبيقات (API) تقديم أي حرف رسومي أو نص مرغوب فيه ، بالإضافة إلى صور رمزية خاصة ، والتي يمكن تقديمها عن طريق تنفيذ واجهات باستخدام وظائف رسومات بسيطة مثل نقطة التحرك ، ورسم الخط ، والمنحنى ، إلخ.'
...
{{<section feature1>}}
---
title: 'تحويل EOT إلى WOFF2 على C #'
...
item4: قم بتحويل EOT إلى WOFF2 باستخدام أسلوب [*SaveToFormat()*](https://reference.aspose.com/font/net/aspose.font/font/methods/savetoformat) ومرر WOFF2 كـ [FontSavingFormats](https://reference.aspose.com/font/net/aspose.font/fontsavingformats).
---
...
{{<section codeexample>}}
---
title: 'مثال على رمز C # تحويل EOT إلى WOFF2'
---