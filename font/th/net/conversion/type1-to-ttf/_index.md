...
title: TYPE1 เป็น TTF Converter API |.NET
description: แปลง TYPE1 เป็น TTF โดยใช้ .NET API บน Windows รวมฟังก์ชันการแปลงฟอนต์ TYPE1 ดั้งเดิมเข้ากับ TTF เข้ากับโซลูชันของคุณเอง
keywords: type1 ถึง ttf api, โซลูชัน tpe12ttf, type1 ถึง ttf net
...
{{<section feature1>}}
---
title: 'การแปลง TYPE1 เป็น TTF ใน C #'
...
item2: เปิดแบบอักษร TYPE1 โดยใช้วิธีการ [*Open()*](https://reference.aspose.com/font/net/aspose.font/font/open/)
item3: ระบุการตั้งค่าเอาต์พุต TTF
item4: แปลง TYPE1 เป็น TTF โดยใช้เมธอด [*SaveToFormat()*](https://reference.aspose.com/font/net/aspose.font/font/savetoformat/) และส่ง TTF เป็น [FontSavingFormats](https://reference.aspose.com/font/net/aspose.font/fontsavingformats/)
---
