...
title: EOT เป็น WOFF Converter API |.NET
description: แปลง EOT เป็น WOFF โดยใช้ .NET API บน Windows รวมฟังก์ชันการแปลงฟอนต์ EOT ดั้งเดิมนี้เป็น WOFF เข้ากับโซลูชันของคุณเอง
keywords: eot ถึง woff api, โซลูชัน eot2woff, eot ถึง woff net
...
item4: แปลง EOT เป็น WOFF โดยใช้วิธีการ [*SaveToFormat()*](https://reference.aspose.com/font/net/aspose.font/font/savetoformat/) และส่ง WOFF เป็น [FontSavingFormats](https://reference.aspose.com/font/net/aspose.font/fontsavingformats/)
---
