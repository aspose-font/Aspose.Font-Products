...
title: TYPE1 เป็น WOFF Converter API |.NET
description: แปลง TYPE1 เป็น WOFF โดยใช้ .NET API บน Windows รวมฟังก์ชันการแปลงฟอนต์ TYPE1 ดั้งเดิมเข้ากับ WOFF เข้ากับโซลูชันของคุณเอง
keywords: type1 ถึง woff api, โซลูชัน type12woff, type1 ถึง woff net
...
item4: แปลง TYPE1 เป็น WOFF โดยใช้วิธีการ [*SaveToFormat()*](https://reference.aspose.com/font/net/aspose.font/font/savetoformat/) และส่ง WOFF เป็น [FontSavingFormats](https://reference.aspose.com/font/net/aspose.font/fontsavingformats/)
---
