...
item2: เปิดแบบอักษร CFF โดยใช้วิธีการ [*Open()*](https://reference.aspose.com/font/net/aspose.font/font/methods/open/index)
item3: ระบุการตั้งค่าเอาต์พุต WOFF2
item4: แปลง CFF เป็น WOFF2 โดยใช้วิธีการ [*SaveToFormat()*](https://reference.aspose.com/font/net/aspose.font/font/methods/savetoformat) และส่ง WOFF2 เป็น [FontSavingFormats](https://reference.aspose.com/font/net/aspose.font/fontsavingformats)
---
