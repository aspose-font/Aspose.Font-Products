...
title: WOFF2 เป็น TTF Converter API |.NET
description: แปลง WOFF2 เป็น TTF โดยใช้ .NET API บน Windows รวมฟังก์ชันการแปลงฟอนต์ WOFF2 ดั้งเดิมนี้เป็น TTF เข้ากับโซลูชันของคุณเอง
keywords: woff2 ถึง ttf api, โซลูชัน woff22ttf, woff2 ถึง ttf net
...
item2: เปิดแบบอักษร WOFF2 โดยใช้วิธีการ [*Open()*](https://reference.aspose.com/font/net/aspose.font/font/methods/open/index)
item3: ระบุการตั้งค่าเอาต์พุต TTF
item4: แปลง WOFF2 เป็น TTF โดยใช้เมธอด [*SaveToFormat()*](https://reference.aspose.com/font/net/aspose.font/font/methods/savetoformat) และส่ง TTF เป็น [FontSavingFormats](https://reference.aspose.com/font/net/aspose.font/fontsavingformats)
---
...
item3: ดูตัวอย่างการใช้งานฟังก์ชันดังกล่าวใน Aspose ข้ามแพลตฟอร์ม [ตัวแปลง WOFF2 เป็น TTF](https://products.aspose.app/font/conversion/woff2-to-ttf) ไปที่ที่เก็บ [GitHub](https://github.com/aspose-font/Aspose.Font-Documentation/tree/master/net-examples) ของเราเพื่อรับตัวอย่างโค้ดเพิ่มเติมเกี่ยวกับวิธีการทำงานกับ Font API Solution สำหรับ C# .NET.
---
