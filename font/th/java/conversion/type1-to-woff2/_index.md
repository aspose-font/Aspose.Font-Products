...
title: API ตัวแปลง TYPE1 เป็น WOFF2 | Java
description: แปลง TYPE1 เป็น WOFF2 โดยใช้ Java API บน Windows และ Linux รวมฟังก์ชันการแปลงฟอนต์ TYPE1 ดั้งเดิมเป็น WOFF2 เข้ากับโซลูชันของคุณเอง
keywords: type1 ถึง woff2 java api, โซลูชัน Java type12woff2 java, type1 ถึง woff2 java
...
{{<section feature1>}}
---
title: การแปลง TYPE1 เป็น WOFF2 บน Java
...
item4: แปลง TYPE1 เป็น WOFF2 โดยใช้ [*SaveToFormat()*](https://reference.aspose.com/font/java/com.aspose.font/Font#saveToFormat-java.io.OutputStream-com.aspose.font.FontSavingFormats-)   เมธอดและส่ง WOFF2 เป็น [FontSavingFormats](https://reference.aspose.com/font/java/com.aspose.font/FontSavingFormats)
---

{{<section feature2>}}
---
title: ข้อกำหนดการแปลง
item1: "ในการดำเนินการแปลง TYPE1 เป็น WOFF2 Java Font API เป็นข้อกำหนดหลัก"
