...
title: CFF เป็น WOFF Converter API | C++
description: แปลง CFF เป็น WOFF Fonts โดยใช้ C ++ API นี้ ฟังก์ชันการแปลงทำงานบน Windows และ Linux และในสภาพแวดล้อมการพัฒนาใดๆ ที่รองรับ C++
metakeywords: c++ CFF เป็น WOFF, CFF ถึง WOFF โซลูชัน c++, CFF เป็น WOFF ตัวแปลงแบบอักษร cpp
...
item4: แปลง CFF เป็น WOFF โดยใช้วิธีการ [*SaveToFormat()*](https://reference.aspose.com/font/cpp/class/aspose.font.font#a670ea97404fd72c2e51b0e8c543c8a45) และส่ง WOFF เป็น [FontSavingFormats](https://reference.aspose.com/font/cpp/namespace/aspose.font#a93d0dcc7c00f5c7027d60e14a5433c74)
---
...
{{<section codeexample>}}
---
title: ตัวอย่างโค้ด CFF การแปลง CFF เป็น WOFF
---