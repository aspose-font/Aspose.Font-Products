...
description: Windows에서 .NET API를 사용하여 TTF를 WOFF로 변환합니다. 이 기본 TTF에서 WOFF 글꼴 변환 기능을 자체 솔루션에 통합하십시오.
keywords: ttf에서 woff API로, ttf2woff 솔루션으로, ttf에서 woff net으로
...
item2: '[*Open()*](https://reference.aspose.com/font/net/aspose.font/font/methods/open/index) 메서드를 사용하여 TTF 글꼴을 엽니다.'
item3: WOFF 출력 설정을 지정합니다.
item4: '[*SaveToFormat()*](https://reference.aspose.com/font/net/aspose.font/font/methods/savetoformat) 메서드를 사용하여 TTF를 WOFF로 변환하고 WOFF를 [FontSavingFormats](https://)로 전달합니다. reference.aspose.com/font/net/aspose.font/fontsavingformats).'
---
