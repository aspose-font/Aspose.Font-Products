...
title: API de conversão de CFF para TTF |.NET
description: Converta CFF para TTF usando a API .NET no Windows. Integre essa funcionalidade nativa de conversão de fonte CFF para TTF em sua própria solução.
keywords: cff para ttf api, solução cff2ttf, cff para ttf net
...
{{<section feature1>}}
---
title: Conversão de CFF para TTF em C#
...
item4: Converta CFF para TTF usando o método [*SaveToFormat()*](https://reference.aspose.com/font/net/aspose.font/font/methods/savetoformat) e passe o TTF como [FontSavingFormats](https://reference.aspose.com/font/net/aspose.font/fontsavingformats).
---
...
item3: Veja o exemplo de realização da funcionalidade mencionada no Aspose multiplataforma [CFF to TTF Converter](https://products.aspose.app/font/conversion/cff-to-ttf). Acesse nosso repositório [GitHub](https://github.com/aspose-font/Aspose.Font-Documentation/tree/master/net-examples) para obter mais exemplos de código sobre como trabalhar com a Font API Solution for C# .NET.
---

{{<section codeexample>}}
---
title: Exemplo de código C# conversão de CFF para TTF
---