...
title: API do conversor TYPE1 para WOFF | Java
description: Converta TYPE1 para WOFF usando a API Java no Windows e Linux. Integre essa funcionalidade de conversão de fonte nativa TYPE1 para WOFF em sua própria solução.
keywords: type1 para woff java api, solução java type12woff, type1 para woff java
...
{{<section feature1>}}
---
title: Conversão de TYPE1 para WOFF em Java
...
item4: Converter TYPE1 para WOFF usando [*SaveToFormat()*](https://reference.aspose.com/font/java/com.aspose.font/Font#saveToFormat-java.io.OutputStream-com.aspose.font.FontSavingFormats-)   Método e passe WOFF como [FontSavingFormats](https://reference.aspose.com/font/java/com.aspose.font/FontSavingFormats).
---

{{<section feature2>}}
---
title: Requisitos de conversão
item1: "Para prosseguir para a conversão de TYPE1 para WOFF, a API de fontes Java é o principal requisito."
...
{{<section codeexample>}}
---
title: Código Java para conversão de TYPE1 para WOFF
---
