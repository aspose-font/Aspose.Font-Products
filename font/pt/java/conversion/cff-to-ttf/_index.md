...
title: API do conversor de CFF para TTF | Java
description: Converta CFF para TTF usando a API Java no Windows e Linux. Integre essa funcionalidade nativa de conversão de fonte CFF para TTF em sua própria solução.
keywords: cff para ttf java api, solução cff2ttf java, cff para ttf java
...
{{<section feature1>}}
---
title: Conversão de CFF para TTF em Java
...
item4: Converter CFF em TTF usando [*SaveToFormat()*](https://reference.aspose.com/font/java/com.aspose.font/Font#saveToFormat-java.io.OutputStream-com.aspose.font.FontSavingFormats-)   Método e passar TTF como [FontSavingFormats](https://reference.aspose.com/font/java/com.aspose.font/FontSavingFormats).
---

{{<section feature2>}}
---
title: Requisitos de conversão
item1: "Para prosseguir para a conversão de CFF para TTF, Java Font API é o principal requisito."
...
item4: Veja o exemplo de realização da funcionalidade mencionada no Aspose multiplataforma [CFF to TTF Converter](https://products.aspose.app/font/conversion/cff-to-ttf). Acesse nosso repositório [GitHub](https://github.com/aspose-font/Aspose.Font-Documentation/tree/master/java-examples) para obter mais exemplos de código sobre como trabalhar com a Font API Solution for Java.
---
