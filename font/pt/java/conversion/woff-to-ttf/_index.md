...
title: API do conversor WOFF para TTF | Java
description: Converta WOFF para TTF usando a API Java no Windows e Linux. Integre essa funcionalidade nativa de conversão de fontes WOFF para TTF em sua própria solução.
keywords: woff para ttf java api, solução woff2ttf java, woff para ttf java
...
{{<section feature1>}}
---
title: Conversão de WOFF para TTF em Java
...
item4: Converter WOFF para TTF usando [*SaveToFormat()*](https://reference.aspose.com/font/java/com.aspose.font/Font#saveToFormat-java.io.OutputStream-com.aspose.font.FontSavingFormats-)   Método e passar TTF como [FontSavingFormats](https://reference.aspose.com/font/java/com.aspose.font/FontSavingFormats).
---

{{<section feature2>}}
---
title: Requisitos de conversão
item1: "Para prosseguir para a conversão de WOFF para TTF, a Java Font API é o principal requisito."
...
item4: Veja o exemplo de realização da funcionalidade mencionada no Aspose multiplataforma [WOFF to TTF Converter](https://products.aspose.app/font/conversion/woff-to-ttf). Acesse nosso repositório [GitHub](https://github.com/aspose-font/Aspose.Font-Documentation/tree/master/java-examples) para obter mais exemplos de código sobre como trabalhar com a Font API Solution for Java.
---

{{<section codeexample>}}
---
title: Código Java para conversão de WOFF para TTF
---