...
title: API do conversor WOFF2 para TTF | Java
description: Converta WOFF2 para TTF usando a API Java no Windows e Linux. Integre essa funcionalidade nativa de conversão de fonte WOFF2 para TTF em sua própria solução.
keywords: woff2 para ttf java api, solução woff22ttf java, woff2 para ttf java
...
{{<section feature1>}}
---
title: Conversão de WOFF2 para TTF em Java
...
item4: Converter WOFF2 para TTF usando [*SaveToFormat()*](https://reference.aspose.com/font/java/com.aspose.font/Font#saveToFormat-java.io.OutputStream-com.aspose.font.FontSavingFormats-)   Método e passar TTF como [FontSavingFormats](https://reference.aspose.com/font/java/com.aspose.font/FontSavingFormats).
---

{{<section feature2>}}
---
title: Requisitos de conversão
item1: "Para prosseguir para a conversão de WOFF2 para TTF, Java Font API é o principal requisito."
...
item4: Veja o exemplo de realização da funcionalidade mencionada no Aspose multiplataforma [WOFF2 to TTF Converter](https://products.aspose.app/font/conversion/woff2-to-ttf). Acesse nosso repositório [GitHub](https://github.com/aspose-font/Aspose.Font-Documentation/tree/master/java-examples) para obter mais exemplos de código sobre como trabalhar com a Font API Solution for Java.
---

{{<section codeexample>}}
---
title: Código Java para conversão de WOFF2 para TTF
---