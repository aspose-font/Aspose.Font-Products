...
title: API do conversor TYPE1 para TTF | Java
description: Converta TYPE1 em TTF usando a API Java no Windows e Linux. Integre essa funcionalidade nativa de conversão de fonte TYPE1 para TTF em sua própria solução.
keywords: type1 para ttf java api, solução java type12ttf, type1 para ttf java
...
{{<section feature1>}}
---
title: Conversão de TYPE1 para TTF em Java
...
item4: Converter TYPE1 em TTF usando [*SaveToFormat()*](https://reference.aspose.com/font/java/com.aspose.font/Font#saveToFormat-java.io.OutputStream-com.aspose.font.FontSavingFormats-)   Método e passar TTF como [FontSavingFormats](https://reference.aspose.com/font/java/com.aspose.font/FontSavingFormats).
---

{{<section feature2>}}
---
title: Requisitos de conversão
item1: "Para prosseguir para a conversão de TYPE1 para TTF, a Java Font API é o principal requisito."
...
{{<section codeexample>}}
---
title: Código Java para conversão de TYPE1 para TTF
---