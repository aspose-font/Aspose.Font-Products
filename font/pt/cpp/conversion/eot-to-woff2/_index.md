...
title: API do conversor EOT para WOFF2 | C++
description: Converta fontes EOT para WOFF2 usando esta API C++. A funcionalidade de conversão funciona no Windows e no Linux e em qualquer ambiente de desenvolvimento que suporte C++.
metakeywords: c++ EOT para WOFF2, EOT para WOFF2 soluções c++, EOT para WOFF2 conerter fonte cpp
...
h2: Funcionalidade de conversão de EOT para WOFF2 para C++. API para transformar fontes.
---
...
item4: Converta EOT para WOFF2 usando o método [*SaveToFormat()*](https://reference.aspose.com/font/cpp/class/aspose.font.font#a670ea97404fd72c2e51b0e8c543c8a45) e passe WOFF2 como [FontSavingFormats](https://reference.aspose.com/font/cpp/namespace/aspose.font#a93d0dcc7c00f5c7027d60e14a5433c74).
---
